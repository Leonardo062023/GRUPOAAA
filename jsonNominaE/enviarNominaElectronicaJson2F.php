        ...
        if ($prefijoFinal!=null) {
           ...
           AND mes=$idMes";
            ...
            if($rowValidaCon==false){
                ...
                VALUES ('$prefijoAnt','$consecutivoAct',$idMes,$annno,$tercero)";
        ...
        $horasExtrasNocturnasJson=[];
            while($rowHEN=mysqli_fetch_row($horasN)){
                ...
                $horasExtrasNocturnas1=$rowHEN[2];
                   if ($horasExtrasNocturnas1=='0.50') {
                   $horasExtrasNocturnas='1';
                   }else{
                   $horasExtrasNocturnas=$rowHEN[2];
                   }
...
while ( $rowDeduccionSub=mysqli_fetch_row($deduccionSub)) {
    ...
    while ($rowDeuda=mysqli_fetch_row($deuda)){
        ...
        //Total Devengados
        echo $auxTransporte.'-----'.$sueldo.'-----'.$valorDF.'-----'.$valorHENTo.'-----'.$valorHERTo.'-----'.$valorHEDDFTo.'-----'.$valorHEDDTo.'-----'.$valorHENDFTo
