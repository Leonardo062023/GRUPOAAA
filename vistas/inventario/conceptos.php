    ...
    <div class="container-fluid">
        <div class="row content">
            ...
            <div class="col-sm-10 col-md-10 col-lg-10">
                ...
                <a href="<?php echo "modificar_GF_PLAN_INVENTARIO.php?action=1&id_plan_inv=" . $id; ?>" class="glyphicon glyphicon-circle-arrow-left" style="display:inline-block;margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none;" title="Volver"></a>
                <h5 id="forma-titulo3a" align="center" style="width:92%; display:inline-block; margin: 5px 4px 10px;background-color: #0e315a; color: #ffffff; border-radius: 5px;"><?php echo ucwords((strtolower($info[0][0]))); ?></h5>
                <?php
                echo "<input type='hidden' name='txtConcepto' id='txtConcepto' value='$xda'><input type='hidden' name='txtPlanI' id='txtPlanI' value=' " . $info[0][1] . "'>";
                ?>
                    ...
                    <table id="tablaX" class="table table-striped table-condensed display detalle" cellpadding="0" width="100%">
                        ...
                        <tbody>
                            ...
                            foreach ($data as $row) {
                                ...
                                $html .= "\n\t<td style='text-align: right;'><span id='lblValor" . $row[3] . "' style='font-size: 10px;'>" . number_format($valor, 2) . "</span></td>";
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function eliminar($x) {
            ...
            $("#btnDel").click(function() {
                $.post("access.php?controller=ConceptoTarifa&action=Eliminar", {
                    concepto: $x
                }, function(data) {
                    let res = data;
                    if (res) {
        ...
        function cambiarCampos($x) {
            ...
            $.get("access.php?controller=ConceptoTarifa&action=obtenerCantidadElementos", {
                elemento: id_p
            }, function(data) {
        ...
        function enviarX($x) {
            ...
            $.post("access.php?controller=Inventario&action=obtenerListadoD", {
                elemento: elm
            }, function(data) {
        ...
        function eliminarHerencia($x) {
            ...
            $.post("access.php?controller=Inventario&action=eliminarRelacion", {
                id: $x
            }, function(data) {
                let res = JSON.parse(data);
                if (res.data === true) {
