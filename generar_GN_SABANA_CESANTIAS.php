...
?>
    ...
    <title>Sábana de Cesantias</title>
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Sábana de Cesantias</h2>
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="" target="_blank">
                        ...
                        <?php
                        $uniE = " SELECT id_unico, nombre FROM gn_tipo_empleado";
                        $Ueje = $mysqli->query($uniE);
                        ?>
                        <div class="form-group" style="margin-top: -5px">
                            <div class="clasUni" style="margin-top: -5px">
                                <label for="sltTipoE" class="control-label col-sm-5" style="margin-top: 0px">
                                    Tipo Empleado:
                                </label>
                                <div class="col-sm-5 col-md-5 col-lg-5">
                                    <select name="sltTipoE" id="sltTipoE" title="Seleccione Tipo Empleado" style="height: 30px; " class="select2_single form-control" >
                        ...
                        <?php
                        $uniE = " SELECT id_unico, nombre FROM gn_regimen_cesantias";
                        $Ueje = $mysqli->query($uniE);
                        ?>
                        <div class="form-group" style="margin-top: -5px">
                            <div class="clasUni" style="margin-top: -0px">
                                <label for="sltRegimenC" class="control-label col-sm-5" style="margin-top: 0px">
                                    Régimen Cesantías:
                                </label>
                                <div class="col-sm-5 col-md-5 col-lg-5">
                                    <select name="sltRegimenC" id="sltRegimenC" title="Seleccione Régimen Cesantías" style="height: 30px; " class="select2_single form-control" >
                                        <option value="">Régimen Cesantías</option>
                                        <?php
                                        while($rowU = mysqli_fetch_row($Ueje)){
                                            echo "<option value=".$rowU[0].">".$rowU[1]."</option>";
                                        }
                        ...
                        <div class="form-group" style="margin-top: -5px;">
                        <label for="chkTipoA" class="control-label col-sm-5 col-md-5 col-lg-5">Informe Por Grupo Gestion</label>
                        <div class="col-sm-5 col-md-5 col-lg-5">
                            <input type="radio" name="optGrupo" id="optGrupo" value="1">Si
                            <input type="radio" name="optGrupo" id="optGrupo" checked="checked" value="2">No
                            </div>
                        </div>
                        <div class="form-group" style="margin-top: -5px;">
    ...
    <script>
        ...
        $("#enviar").click(function(){
            if($("#optPdf").is(':checked')){
                $("#form").attr("action", "informes_nomina/generar_INF_SABANA_CESANTPRO.php?t=1");
            } else {
                if($("#optExcel").is(":checked")){
                    $("#form").attr("action", "informes_nomina/generar_INF_SABANA_CESANTPRO.php?t=2");
                }
            }
        });
    </script>
