    ...
    switch ($filaELS[2]) {
        ...
        case 3:
            $str = "SELECT    DATE_FORMAT(mov.fecha, '%d/%m/%Y'), mov.numero, tpm.sigla,
                              ...
                              mov.descripcion, dtm.cantidad, ((dtm.valor+dtm.iva) * dtm.cantidad), tpm.clase, dtm.hora, dtm.valor, dtm.valor,
                              IF(CONCAT_WS(' ', tere.nombreuno, tere.nombredos, tere.apellidouno, tere.apellidodos)='' ,
                              (tere.razonsocial),CONCAT_WS(' ',tere.nombreuno,tere.nombredos,tere.apellidouno,tere.apellidodos)) AS 'NOMBRETER2',
                              IF(CONCAT_WS(' ', tere1.nombreuno, tere1.nombredos, tere1.apellidouno, tere1.apellidodos)='' ,
                              (tere1.razonsocial),CONCAT_WS(' ',tere1.nombreuno,tere1.nombredos,tere1.apellidouno,tere1.apellidodos)) AS 'NOMBRETERpro'
                    ...
                    LEFT JOIN gf_tercero           as tere ON mov.tercero2= tere.id_unico
                    LEFT JOIN gf_tercero           as tere1 ON mov.tercero= tere1.id_unico
            ...
            while($row = mysqli_fetch_row($res)){
                ...
                $html .= "\n\t\t\t\t<td style='text-align: right;'>".number_format($xcantE, 2, '.', ',')."</td>";
                $html .= "\n\t\t\t\t<td style='text-align: right;'>".number_format($xcantS, 2, '.', ',')."</td>";
                $html .= "\n\t\t\t\t<td style='text-align: right;'>".number_format($xsaldo, 2, '.', ',')."</td>";
