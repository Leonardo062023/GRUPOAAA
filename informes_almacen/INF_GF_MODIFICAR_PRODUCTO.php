...
UPPER(ti.nombre),
CASE
    WHEN ter.digitoverficacion IS NULL OR ter.digitoverficacion = '' THEN ter.numeroidentificacion
    ELSE ter.numeroidentificacion || ' - ' || ter.digitoverficacion
END,
dir.direccion,
tel.valor,
ter.ruta_logo 
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        ...
        switch ($conexion) {
            case 1:
                ...
                p.id_unico, 
                CONCAT(pi.codi, ' ', pi.nombre),
                p.descripcion, 
                p.valor, 
                p.vida_util_remanente, 
            ...
            WHERE 
                m.compania = $compania AND p.id_unico IS NOT NULL
            ORDER BY 
                p.id_unico
            ");
                break;
            case 2:
                ...
                pi.codi || ' ' || pi.nombre, p.descripcion, p.valor, p.vida_util_remanente, 
                TO_CHAR(p.fecha_adquisicion, 'DD/MM/YYYY'), 
                pi.ficha 
