                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    if(empty($idT))
                                    {
                                        $emp = "SELECT 						
                                                        ...
                                                        e.tercero,
                                                        t.id_unico,
                                                        CONCAT_WS(' ',e.codigointerno,t.nombreuno,t.nombredos,t.apellidouno,t.apellidodos,t.numeroidentificacion)
                                                FROM gn_empleado e
                                                LEFT JOIN gf_tercero t ON e.tercero = t.id_unico
                                                WHERE e.id_unico !=2
                                    ...
                                    else
                                    {
                                        $emp = "SELECT 						
                                                        ...
                                                        CONCAT_WS(' ',e.codigointerno,t.nombreuno,t.nombredos,t.apellidouno,t.apellidodos,t.numeroidentificacion)
                                                FROM gn_empleado e
                                                LEFT JOIN gf_tercero t ON e.tercero = t.id_unico WHERE e.id_unico != $idT AND e.id_unico !=2";
                                        $idTer = $idT;
                                    }
