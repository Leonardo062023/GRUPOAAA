...
if(!empty($_GET['movimiento'])){
    ...
    $porcIva        = $rowPrimaria[16]; $iva              = $rowPrimaria[16]; $tipoDocSoporte = $rowPrimaria[17]; $numDocSoporte     = $rowPrimaria[18]; $fuente = $rowPrimaria[20];
...
<body onload="clean_inputs()">
    ...
    <script>
        ...
        function abrirFichaI(cantidad,ficha,valor,movimiento,idM){
            ...
            $.ajax({
                type: 'POST',
                url: "modalProducto1.php#modalFichaInventario",
                data: form_data,
                success: function (data, textStatus, jqXHR) {
