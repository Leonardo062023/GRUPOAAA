...
if (isset($_GET["id_ciudad"])){ 
  $id_ciudad = base64_decode(($_GET["id_ciudad"]));
  $rowss = $con->Listar("SELECT * FROM gf_ciudad WHERE id_unico = '$id_ciudad'");
   $titulo = "modificar  ";
  }else{
    $row = $con->Listar("SELECT id_unico,nombre from gf_departamento ORDER BY nombre ASC");
    $titulo = "registrar ";
  }
 ?>

<title><?php echo $titulo.'Ciudad'?></title>
</head>
<body>
...
<div class="col-sm-7 text-left" style="margin-top:-10px">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;margin-bottom: 10px;"><?php echo $titulo.'Ciudad'?></h2>
            ...
            <div class="form-group" style="margin-top: -10px;">
              <label for="nombre" class="col-sm-5 control-label"><strong style="color:#03C1FB;">*</strong>Nombre:</label>
                ...
                <script>
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificar_GF_CiudadJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
