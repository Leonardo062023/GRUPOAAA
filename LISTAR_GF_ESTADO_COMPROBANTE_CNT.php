...
switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_estado_comprobante_cnt ORDER BY Nombre ASC");
    break;
    case '2':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_estado_comprobante_cnt ORDER BY Nombre ASC");
    break;
 							...
 							for ($i=0; $i <count($row) ; $i++) {?> 
               							<tr>
                							...
                							<td>
                								...
                								<a href="EDITAR_GF_ESTADO_COMPROBANTE_CNT.php?id=<?php echo ($row[$i][0]);?>">
  ...
  <script type="text/javascript">
        ...
        $("#myModal").modal('show');
                        $("#ver").click(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarEstadoComprobanteCntJson.php?action==1",
                                data: form_data,
