...
class PDF extends FPDF
{
    ...
    { 
        ...
        $this->Cell(330,10,utf8_decode('SÁBANA DE PRIMA DE SERVICIOS'),0,0,'C');
...
if(empty($unidad) && empty($grupog) && empty($periodo)){
    ...
    while($G = mysqli_fetch_row($resgru)){
       ...
       echo $conceptos = "SELECT DISTINCT      n.concepto, 
              ...
              WHERE  e.grupogestion = '$G[0]' AND p.tipoprocesonomina = 2  
              ORDER BY c.orden";
       echo "<br>";
      ...
      echo  $numero_con = "SELECT COUNT(DISTINCT n.concepto) "
            ...
            . "LEFT JOIN gn_periodo p ON n.periodo = p.id_unico "
            . "LEFT JOIN gn_empleado e ON n.empleado = e.id_unico WHERE  e.grupogestion = '$G[0]]' AND p.tipoprocesonomina = 2 ";
        ...
        $sqlemp =" SELECT DISTINCT e.id_unico, 
                            ...
                            WHERE e.id_unico !=2 AND vr.estado !=2 AND e.grupogestion = $G[0] AND n.concepto = 109 AND n.periodo =$periodo";
        ...
        while($emple =  mysqli_fetch_row($emp)){
            ...
            while($CO = mysqli_fetch_row($con2)){
                ...
                $novco = "SELECT n.id_unico, sum(n.valor) "
                    ...
                    . "LEFT JOIN gn_empleado e ON n.empleado = e.id_unico "
                    . "LEFT JOIN gn_periodo p ON n.periodo = p.id_unico "
                    . "WHERE c.id_unico = '$CO[2]' AND e.id_unico = '$emple[0]' AND p.tipoprocesonomina = 2 ORDER BY c.orden";
        ...
        $con3 = "SELECT DISTINCT      n.concepto, 
              ...
              LEFT JOIN gn_empleado e ON n.empleado = e.id_unico
              LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
              WHERE  e.grupogestion = $G[0]  AND p.tipoprocesonomina = 2 ORDER BY c.clase ORDER BY c.orden";
        ...
        while($co3 = mysqli_fetch_row($co2)){
            ...
            $sumco = "SELECT SUM(n.valor), n.concepto 
                    ...
                    LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                    LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
                    WHERE c.id_unico = '$co3[2]' AND vr.estado != 2 AND e.grupogestion = $G[0] AND p.tipoprocesonomina = 2 ORDER BY c.orden";
            ...
            while($emple =  mysqli_fetch_row($emp)){
                ...
                while($CO = mysqli_fetch_row($con2)){
                    ...
                    $novco = "SELECT n.id_unico, n.valor FROM gn_novedad n "
                        . "LEFT JOIN  gn_concepto c ON n.concepto = c.id_unico "
                        . "LEFT JOIN gn_empleado e ON n.empleado = e.id_unico "
                        . "WHERE c.id_unico = '$CO[2]' AND e.id_unico = '$emple[0]' AND n.periodo = $periodo AND e.grupogestion = '$G[0]' ORDER BY c.orden";
        ...
        while($G = mysqli_fetch_row($resgru)){
            ...
            while($emple =  mysqli_fetch_row($emp)){
                ...
                while($CO = mysqli_fetch_row($con2)){
                    ...
                    $novco = "SELECT n.id_unico, SUM(n.valor) 
                      ...
                      WHERE c.id_unico = '$CO[2]' AND e.id_unico = '$emple[0]'  AND e.grupogestion = $grupog AND p.tipoprocesonomina = 2 ORDER BY c.orden";
            ...
            while($co3 = mysqli_fetch_row($co2)){
                ...
                echo $sumco = "SELECT SUM(n.valor), n.concepto 
                           ...
                           LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                           LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
                           WHERE c.id_unico = '$co3[2]'   AND e.grupogestion = $grupog AND e.unidadejecutora = '$unidad' AND vr.estado != 2 AND p.tipoprocesonomina = 2 ORDER BY c.orden";
            ...
            while($emple =  mysqli_fetch_row($emp)){
                ...
                while($CO = mysqli_fetch_row($con2)){
                    ...
                    $novco = "SELECT n.id_unico, n.valor 
                      FROM gn_novedad n LEFT JOIN  gn_concepto c ON n.concepto = c.id_unico LEFT JOIN gn_empleado e ON n.empleado = e.id_unico 
                      WHERE c.id_unico = '$CO[2]' AND e.id_unico = '$emple[0]' AND n.periodo = $periodo AND e.grupogestion = $grupog ORDER BY c.orden";
        ...
        while($G = mysqli_fetch_row($resgru)){
            ...
            while($emple =  mysqli_fetch_row($emp)){
                ...
                while($CO = mysqli_fetch_row($con2)){
                    ...
                    $novco = "SELECT n.id_unico, n.valor "
                        . "FROM gn_novedad n LEFT JOIN  gn_concepto c ON n.concepto = c.id_unico LEFT JOIN gn_empleado e ON n.empleado = e.id_unico "
                        . "LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico "
                        . "WHERE c.id_unico = '$CO[2]' AND e.id_unico = '$emple[0]' AND n.periodo = $periodo AND vr.estado != 2 ORDER BY c.orden";
            ...
            while($co3 = mysqli_fetch_row($co2)){
                 ...
                 $sumco = "SELECT SUM(n.valor),n.concepto 
                    ...
                    LEFT JOIN gn_empleado e ON n.empleado = e.id_unico 
                    LEFT JOIN gn_concepto c ON n.concepto = c.id_unico 
                    WHERE c.id_unico = '$co3[2]'  AND n.periodo = $periodo  AND e.grupogestion = '$G[0]' ORDER BY c.orden";
