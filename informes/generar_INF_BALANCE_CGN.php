        ...
        while ($filactas = mysqli_fetch_array($ccuentas)) {
            ...
            if ($sald == 0 && $debit == 0 && $credit == 0) {
                ...
                if (strlen($filactas['numcuen']) <= 6) { #Validamos para que solo imprima 6 digitos
                    ...
                    echo "<td>" . number_format(($corriente), 2, '.', ',') . "</td>";
                    echo "<td>" . number_format(($nocorriente), 2, '.', ',') . "</td>";
                    echo "</tr>";
                }
            }
        }
        ...
        while ($filactas = mysqli_fetch_array($ccuentas)) {
            if (strlen($filactas['numcuen']) <= 6) { #Validamos para que solo imprima 6 digitos
                ...
                if ($sald == 0 && $debit == 0 && $credit == 0) {
                    ...
                    $pdf->Cell(35, 4, number_format(($sald), 2, '.', ','), 0, 0, 'R');
                    $pdf->Cell(35, 4, number_format(($debit), 2, '.', ','), 0, 0, 'R');
                    $pdf->Cell(35, 4, number_format(($credit), 2, '.', ','), 0, 0, 'R');
                    $pdf->Cell(35, 4, number_format(($nsald), 2, '.', ','), 0, 0, 'R');
                    $pdf->Cell(35, 4, number_format(($corriente), 2, '.', ','), 0, 0, 'R');
                    $pdf->Cell(35, 4, number_format(($nocorriente), 2, '.', ','), 0, 0, 'R');
                    $pdf->Ln($h);
            ...
            if ($sald == 0 && $debit == 0 && $credit == 0) {
                ...
                if (strlen($filactas['numcuen']) <= 6) { #Validamos para que solo imprima 6 digitos
                    ...
                    if (strlen($filactas['numcuen']) == 1) {
                        ...
                        $filas .= "D\t" . $filactas['numcuen'] . "\t" . ($sald) . "\t" . ($debit) . "\t" . ($credit) . "\t" . ($nsald) . "\t" . ($corriente) . "\t" . ($nocorriente) . "\n";
                        ...
                        $filas .= "D\t" . $y . "\t" . ($sald) . "\t" . ($debit) . "\t" . ($credit) . "\t" . ($nsald) . "\t" . ($corriente) . "\t" . ($nocorriente) . "\n";
                        ...
                        $filas .= "D\t" . $y[0] . "." . $y[1] . "." . $y[2] . $y[3] . "\t" . ($sald) . "\t" . ($debit) . "\t" . ($credit) . "\t" . ($nsald) . "\t" . ($corriente) . "\t" . ($nocorriente) . "\n";
                        ...
                        $y = substr($y, 0, strlen($y) - 1);     //Quitamos punto al final del string
                        $y = explode(".", $y);       //Convertimos en un array
                        $filas .= "D\t" . $y[0] . "." . $y[1] . "." . $y[2] . $y[3] . "." . $y[4] . $y[5] . "\t" . ($sald) . "\t" . ($debit) . "\t" . ($credit) . "\t" . ($nsald) . "\t" . ($corriente) . "\t" . ($nocorriente) . "\n";
                    }
                }
            }
        }
