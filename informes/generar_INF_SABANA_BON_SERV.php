...
class PDF extends FPDF
{
    ...
    { 
        ...
        $this->SetFont('Arial','',10);
        $this->Cell(330,10,utf8_decode('SÁBANA DE BONIFICACION POR SERVICIOS PRESTADOS'),0,0,'C');
...
if(empty($unidad) && empty($grupog) && empty($periodo)){
    ...
    while($G = mysqli_fetch_row($resgru)){
       ...
       echo $conceptos = "SELECT DISTINCT      n.concepto, 
              ...
              WHERE  e.grupogestion = '$G[0]' AND p.tipoprocesonomina = 4  
      ...
      echo  $numero_con = "SELECT COUNT(DISTINCT n.concepto) "
            ...
            . "LEFT JOIN gn_periodo p ON n.periodo = p.id_unico "
            . "LEFT JOIN gn_empleado e ON n.empleado = e.id_unico WHERE  e.grupogestion = '$G[0]]' AND p.tipoprocesonomina = 4 ";
        ...
        $sqlemp =" SELECT    e.id_unico, 
                            ...
                            WHERE e.id_unico !=2 AND vr.estado !=2 AND e.grupogestion = $G[0] AND n.concepto = 109";
        ...
        while($emple =  mysqli_fetch_row($emp)){
            ...
            while($CO = mysqli_fetch_row($con2)){
                ...
                $novco = "SELECT n.id_unico, sum(n.valor) "
                    ...
                    . "LEFT JOIN gn_empleado e ON n.empleado = e.id_unico "
                    . "LEFT JOIN gn_periodo p ON n.periodo = p.id_unico "
                    . "WHERE c.id_unico = '$CO[2]' AND e.id_unico = '$emple[0]' AND p.tipoprocesonomina = 4 ";
        ...
        $con3 = "SELECT DISTINCT      n.concepto, 
              ...
              LEFT JOIN gn_empleado e ON n.empleado = e.id_unico
              LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
              WHERE  e.grupogestion = $G[0]  AND p.tipoprocesonomina = 4 ORDER BY c.clase ";
        ...
        while($co3 = mysqli_fetch_row($co2)){
            ...
            $sumco = "SELECT SUM(n.valor), n.concepto 
                    ...
                    LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                    LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
                    WHERE c.id_unico = '$co3[2]' AND vr.estado != 2 AND e.grupogestion = $G[0] AND p.tipoprocesonomina = 4";
    ...
    if(empty($periodo) && empty($grupog)){
        ...
        while($G = mysqli_fetch_row($resgru)){
            ...
            $conceptos = "SELECT DISTINCT      n.concepto, 
              ...
              LEFT JOIN gn_empleado e ON n.empleado = e.id_unico
              LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
              WHERE  e.unidadejecutora = $unidad  AND e.grupogestion = '$G[0]' AND p.tipoprocesonomina = 4
              ORDER BY c.clase";
            ...
            $sqlemp =" SELECT    e.id_unico, 
                            ...
                            LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                            LEFT JOIN gn_novedad n ON n.empleado = e.id_unico
                            WHERE e.id_unico !=2 AND vr.estado !=2 AND e.unidadejecutora = $unidad AND e.grupogestion = '$G[0]' AND n.concepto = 111";
            ...
            while($emple =  mysqli_fetch_row($emp)){
                ...
                while($CO = mysqli_fetch_row($con2)){
                    ...
                    $novco = "SELECT n.id_unico, sum(n.valor) "
                             ...
                             . "LEFT JOIN gn_empleado e ON n.empleado = e.id_unico "
                             . "LEFT JOIN gn_periodo p On n.periodo = p.id_unico "
                             . "WHERE c.id_unico = '$CO[2]' AND e.id_unico = '$emple[0]' AND p.tipoprocesonomina = 4 ORDER BY c.clase ";
            ...
            $saltot = "SELECT  SUM(c.salarioactual) "
                ...
                . "LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico "
                . "LEFT JOIN gn_novedad n ON n.empleado = e.id_unico "
                . "WHERE  e.unidadejecutora = $unidad AND vr.estado != 2 AND e.grupogestion = '$G[0]' AND n.concepto = 111 ";
            ...
            $con3 = "SELECT DISTINCT      n.concepto, 
              ...
              LEFT JOIN gn_empleado e ON n.empleado = e.id_unico
              LEFT JOIN gn_periodo p On n.periodo = p.id_unico
              WHERE  e.grupogestion = '$G[0]' AND p.tipoprocesonomina = 4 AND e.unidadejecutora = '$unidad'
              ORDER BY c.clase";
            ...
            while($co3 = mysqli_fetch_row($co2)){
                ...
                $sumco = "SELECT SUM(n.valor), n.concepto "
                        ...
                        . "LEFT JOIN  gn_vinculacion_retiro vr ON vr.empleado = e.id_unico "
                        . "LEFT JOIN gn_periodo p ON n.periodo = p.id_unico "
                        . "WHERE c.id_unico = '$co3[2]' AND e.unidadejecutora = '$unidad' AND vr.estado !=2 AND e.grupogestion = '$G[0]' AND p.tipoprocesonomina = 4 ";
        ...
        while($G = mysqli_fetch_row($resgru)){
            ...
            $numero_con = "SELECT COUNT(DISTINCT n.concepto) 
                    ...
                    LEFT JOIN gn_empleado e ON n.empleado = e.id_unico
                    LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
                    WHERE n.periodo =$periodo  AND e.unidadejecutora = '$unidad' AND e.grupogestion = '$G[0]' AND p.tipoprocesonomina = 4 ";
            ...
            $saltot = "SELECT  SUM(c.salarioactual) "
                ...
                . "LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico "
                . "LEFT JOIN gn_novedad n ON n.empleado = e.id_unico "
                . "WHERE vr.estado != 2 AND e.grupogestion = '$G[0]' AND n.concepto = 111";
        ...
        while($G = mysqli_fetch_row($resgru)){
            ...
            $conceptos = "SELECT DISTINCT      n.concepto, 
              ...
              LEFT JOIN gn_empleado e ON n.empleado = e.id_unico
              LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
              WHERE  e.grupogestion = $grupog AND e.unidadejecutora = '$unidad' AND p.tipoprocesonomina = 4
              ORDER BY c.clase";
            ...
            $sqlemp =" SELECT    e.id_unico, 
                            ...
                            LEFT JOIN gn_categoria ca ON tc.categoria = ca.id_unico
                            LEFT JOIN gn_novedad n ON n.empleado = e.id_unico
                            WHERE e.id_unico !=2 AND e.grupogestion = $grupog AND e.unidadejecutora = '$unidad' AND n.concepto = 111";
            ...
            while($emple =  mysqli_fetch_row($emp)){
                ...
                while($CO = mysqli_fetch_row($con2)){
                    ...
                    $novco = "SELECT n.id_unico, SUM(n.valor) 
                      ...
                      WHERE c.id_unico = '$CO[2]' AND e.id_unico = '$emple[0]'  AND e.grupogestion = $grupog AND p.tipoprocesonomina = 4";
            ...
            $saltot = "SELECT  SUM(c.salarioactual) 
               ...
               LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
               LEFT JOIN gn_novedad n ON n.empleado = e.id_unico
               WHERE  e.grupogestion = $grupog AND e.unidadejecutora = '$unidad' AND vr.estado !=2 AND n.concepto = 111";
            ...
            while($co3 = mysqli_fetch_row($co2)){
                ...
                echo $sumco = "SELECT SUM(n.valor), n.concepto 
                           ...
                           LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                           LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
                           WHERE c.id_unico = '$co3[2]'   AND e.grupogestion = $grupog AND e.unidadejecutora = '$unidad' AND vr.estado != 2 AND p.tipoprocesonomina = 4";
        ...
        while($G = mysqli_fetch_row($resgru)){
            ...
            $sqlemp =" SELECT    e.id_unico, 
                            ...
                            LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                            LEFT JOIN gn_novedad n ON n.empleado = e.id_unico
                            WHERE e.id_unico !=2 AND e.grupogestion = $grupog AND e.unidadejecutora = '$unidad'  AND vr.estado !=2 AND n.concepto = 111";
    ...
    if(empty($grupog) && !empty($periodo)){
        ...
        while($G = mysqli_fetch_row($resgru)){
            ...
            echo $sqlemp =" SELECT    e.id_unico, 
                            ...
                            LEFT JOIN gn_novedad n ON n.empleado = e.id_unico
                            LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
                            WHERE e.id_unico !=2 AND vr.estado !=2 AND e.grupogestion = '$G[0]' AND n.concepto = 111 AND p.id_unico = '$periodo'";
            echo "<br/>";
            $emp = $mysqli->query($sqlemp); 
            $con2 = $mysqli->query($conceptos);
            $pdf->SetFont('Arial','',8);
            ...
            $saltot = "SELECT  SUM(c.salarioactual) 
                ...
                LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico 
                LEFT JOIN gn_novedad n ON n.empleado = e.id_unico 
                WHERE vr.estado != 2 AND e.grupogestion = '$G[0]' AND n.concepto = 111 AND n.periodo = '$periodo'";
        ...
        while($G = mysqli_fetch_row($resgru)){
            ...
            $numero_con = "SELECT COUNT(DISTINCT n.concepto) FROM gn_novedad n LEFT JOIN gn_concepto c ON n.concepto = c.id_unico  
                       LEFT JOIN gn_empleado e ON n.empleado = e.id_unico 
                       LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
                       WHERE   e.grupogestion = $grupog AND p.tipoprocesonomina = 4 ";
            ...
            $sqlemp =" SELECT  DISTINCT  e.id_unico, 
                            ...
                            LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                            LEFT JOIN gn_novedad n ON n.empleado = e.id_unico 
                            WHERE e.id_unico !=2 AND e.grupogestion = $grupog AND vr.estado !=2 AND n.concepto = 111";
            ...
            $saltot = "SELECT  SUM(c.salarioactual) 
                  ...
                  LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                  LEFT JOIN gn_novedad n ON n.empleado = e.id_unico
                  WHERE  e.grupogestion = $grupog AND vr.estado != 2 AND n.concepto = 111";
            ...
            while($co3 = mysqli_fetch_row($co2)){
                ...
                echo $sumco = "SELECT SUM(n.valor), n.concepto 
                              ...
                              LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                              LEFT JOIN gn_periodo p ON n.periodo = p.id_unico
                              WHERE c.id_unico = '$co3[2]'   AND e.grupogestion = $grupog AND vr.estado !=2 AND p.tipoprocesonomina = 4";
        ...
        while($G = mysqli_fetch_row($resgru)){
            ...
            $sqlemp =" SELECT    e.id_unico, 
                            ...
                            LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                            LEFT JOIN gn_novedad n ON n.empleado = e.id_unico
                            WHERE e.id_unico !=2 AND e.grupogestion = $grupog  AND vr.estado !=2 AND n.concepto = 111 AND n.periodo = '$periodo'";
            ...
            $saltot = "SELECT  SUM(c.salarioactual) 
                   ...
                   LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                   LEFT JOIN gn_novedad n ON n.empleado = e.id_unico
                   WHERE  e.grupogestion = $grupog AND vr.estado !=2 AND n.concepto = 111 AND n.periodo = '$periodo'";
