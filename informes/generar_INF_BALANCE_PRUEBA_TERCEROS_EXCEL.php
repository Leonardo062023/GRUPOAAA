...
<br>
  ...
  <tr>
        <th colspan="2" align="center"><strong>Usuario: <?php echo $usuario; ?></strong></th>
        <th colspan="2" align="center"><strong>Fecha: <?php echo $fechaActual; ?></strong></th>
        <th colspan="2" align="center"><strong>Maquina: <?php echo gethostname(); ?></strong></th>
  </tr>
</table>
    </body>
</html>