...
header("Content-Disposition: attachment; filename=Informe_Ejec_Pptal_Gasto_Pagos.xls");
...
<title>EJECUCIÓN PPTAL GASTOS - PAGOS</title>
</head>
<body>
<table width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr>
        ...
        <th colspan="11" align="center"><strong>
            ...
            <br/><?php echo $nombreIdent.' : '.$numeroIdent."<br/>".$direccinTer.' Tel:'.$telefonoTer ?>
           <br/>&nbsp;
           <br/>EJECUCIÓN PRESUPUESTAL GASTOS - PAGOS
           <br/>Rubros del <?php echo $codigoI.' al '.$codigoF ?>
           <br/>Mes Acumulado <?php echo $month1.' - '.$anno ?><br/>&nbsp;</strong>
        </th>
        <?php } ?>
    ...
    <tr>
        ...
        <td colspan ="4" align="center"><strong>MODIFICACIONES PAC</strong></td>
        <td rowspan="2" align="center"><strong>PAC DEFINITIVO</strong></td>
        <td rowspan="2" align="center"><strong>PAC PAGOS</strong></td>
        <?php }  else { ?>
