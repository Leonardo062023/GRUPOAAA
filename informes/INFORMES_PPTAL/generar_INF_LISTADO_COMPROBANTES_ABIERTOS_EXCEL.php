...
?>
 ...
 <tr>
        <td align="rigth" colspan="6" ><strong><i><?php echo 'TOTAL FINAL';?></i></strong></td>
        <td><strong><i><?php echo number_format($tolfi,2,'.',',')?></i></strong></td>
        <td></td>
        <td><strong><i><?php echo number_format($tolfi1,2,'.',',')?></i></strong></td>
</tr>