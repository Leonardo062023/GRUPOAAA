...
<?php
$sqlTipoComp = "SELECT   c.nombre,rd.orden,IF(CONCAT_WS(' ',
                    tr.nombreuno,
                    tr.nombredos,
                    tr.apellidouno,
                    tr.apellidodos) 
...
<label><b><?php echo $firma[2] ?></b></label><br>
<label><b><?php echo $firma[0] ?></b></label>
</body>
</html>