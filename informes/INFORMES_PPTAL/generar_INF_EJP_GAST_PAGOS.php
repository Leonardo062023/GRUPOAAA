...
$ctas = "SELECT DISTINCT
         ...
         WHERE rpp.codi_presupuesto BETWEEN '$codigoI' AND '$codigoF' AND rpp.parametrizacionanno = $parmanno  ORDER BY rpp.codi_presupuesto ASC";
...
{ 
    ...
    $this->SetFont('Arial','',8);
    if(!empty($_GET['t'])){
    $this->Cell(340,5,utf8_decode('INFORME PAC DE GASTOS'),0,0,'C');
    } else {
        $this->Cell(340,5,utf8_decode('EJECUCION DEL PRESUPUESTO DE GASTOS - PAGOS'),0,0,'C');
    }
    $this->SetFont('Arial','B',8);
    ...
    $this->SetX(20);
    if(!empty($_GET['t'])){
        $this->Cell(27,9, utf8_decode(''),1,0,'C');#
        $this->Cell(70,9,utf8_decode(''),1,0,'C');#
        $this->Cell(15,9,utf8_decode(''),1,0,'C');################
        $this->Cell(27,9,utf8_decode(''),1,0,'C');#
        $this->Cell(108,9,utf8_decode(''),1,0,'C');# 
        $this->Cell(37,9,utf8_decode(''),1,0,'C');#
        $this->Cell(37,9,utf8_decode(''),1,0,'C');###################

            $this->SetX(20);

        $this->Cell(27,9, utf8_decode('RUBRO'),1,0,'C');#
        $this->Cell(70,9,utf8_decode('DETALLE'),1,0,'C');#
        $this->Cell(15,9,utf8_decode('FUENTE'),1,0,'C');################
        $this->Cell(27,4,utf8_decode('PAC'),0,0,'C');#
        $this->Cell(108,4,utf8_decode('MODIFICACIONES PAC'),0,0,'C');
        $this->Cell(37,4,utf8_decode('PAC'),0,0,'C');#
        $this->Cell(37,4,utf8_decode('PAC'),0,0,'C');################
        ...
        $this->Cell(27,5, utf8_decode(''),0,0,'C');#
        $this->Cell(70,5,utf8_decode(''),0,0,'C');#
        $this->Cell(15,5,utf8_decode(''),0,0,'C');###############################
        $this->Cell(27,5,utf8_decode('INICIAL'),0,0,'C');#
        $this->Cell(27,5,utf8_decode('ADICIÓN'),1,0,'C');
        $this->Cell(27,5,utf8_decode('REDUCCIÓN'),1,0,'C');
        $this->Cell(27,5,utf8_decode('TRAS.CREDITO'),1,0,'C');#######################
        $this->Cell(27,5,utf8_decode('TRAS.CONT'),1,0,'C');
        $this->Cell(37,5,utf8_decode('DEFINITIVO'),0,0,'C');
        $this->Cell(37,5,utf8_decode('PAGOS'),0,0,'C');#
    } else {
        ...
        $this->Cell(70,9,utf8_decode('DETALLE'),1,0,'C');#
        $this->Cell(15,9,utf8_decode('FUENTE'),1,0,'C');################
        $this->Cell(27,8,utf8_decode('PRESUPUESTO'),0,0,'C');#
        $this->Cell(108,4,utf8_decode('MODIFICACIONES PRESUPUESTALES'),0,0,'C');
        $this->Cell(27,8,utf8_decode('PRESUPUESTO'),0,0,'C');#
        $this->Cell(27,9,utf8_decode('PAGOS'),1,0,'C');################
        $this->Cell(27,8,utf8_decode('SALDO'),0,0,'C');#
        ...
        $this->Cell(27,5,utf8_decode('TRAS.CREDITO'),1,0,'C');#######################
        $this->Cell(27,5,utf8_decode('TRAS.CONT'),1,0,'C');
        $this->Cell(27,5,utf8_decode('DEFINITIVO'),0,0,'C');
        $this->Cell(27,5,utf8_decode(''),0,0,'C');#
        $this->Cell(27,5,utf8_decode('PRESUPUESTO'),0,0,'C');#    
    }
...
while ($filactas = mysqli_fetch_array($conejc)) 
{
    ...
    if ($p1 == 0  && $p2 == 0  && $p3 == 0 && $p4==0 && $p5==0 && $p6==0 && $p7==0 && $p8==0 && $p9==0 && $p10==0 && $p11==0 && $p12==0 && $p13==0)
        ...
        $pdf->CellFitScale(27,$h,utf8_decode($filactas['codrub']),1,0,'L');
        
        $pdf->CellFitScale(70,$h,'',1,0,'R');
        
        $pdf->CellFitScale(15,$h,utf8_decode($filactas['codfte']),1,0,'L');
        $pdf->CellFitScale(27,$h,number_format($p1,2,'.',','),1,0,'R');
        $pdf->CellFitScale(27,$h,number_format($p2,2,'.',','),1,0,'R');
        $pdf->CellFitScale(27,$h,number_format($p3,2,'.',','),1,0,'R');
        $pdf->CellFitScale(27,$h,number_format($p4,2,'.',','),1,0,'R');
        $pdf->CellFitScale(27,$h,number_format($p5,2,'.',','),1,0,'R');
        $pdf->CellFitScale(37,$h,number_format($p6,2,'.',','),1,0,'R');
        $pdf->CellFitScale(37,$h,number_format($p12,2,'.',','),1,0,'R');
        $total1=$t+$total1;
         $pdf->Ln($h);
        }
}
...
while ($filactas = mysqli_fetch_array($conejc)) 
{
    ...
    if ($p1 == 0  && $p2 == 0  && $p3 == 0 && $p4==0 && $p5==0 && $p6==0 && $p7==0 && $p8==0 && $p9==0 && $p10==0 && $p11==0 && $p12==0 && $p13==0)
        ...
        $pdf->CellFitScale(20,$h,utf8_decode($filactas['codrub']),1,0,'L');
        ...
        $pdf->CellFitScale(27,$h,number_format($p4,2,'.',','),1,0,'R');
        $pdf->CellFitScale(27,$h,number_format($p5,2,'.',','),1,0,'R');
        $pdf->CellFitScale(27,$h,number_format($p6,2,'.',','),1,0,'R');
        $pdf->CellFitScale(27,$h,number_format($p12,2,'.',','),1,0,'R');
        $pdf->CellFitScale(27,$h,number_format($t,2,'.',','),1,0,'R');
        $total1=$t+$total1;
         $pdf->Ln($h);
        }
}
...
$pdf->SetFont('Arial','B',8);
  $pdf->Cell(75,4,'TOTALES: ',0,0,'R');
  $pdf->CellFitScale(146,4,number_format($total1,2,'.',','),0,0,'R');
## FIN TOTALES ##
$pdf->Ln(5);
$pdf->setX(20);

        $pdf->Cell(321,0.5,utf8_decode(''),1,0,'R');
...
$x = $pdf->GetX();
 ...
 ######### FIN FIRMAS #########
 $pdf->Output(0,utf8_decode('Informe_Ejecuciones_Pptales_Gastos_Pagos('.date('d-m-Y').').pdf'),0);
?>