    ...
    if(!empty($periodo) && empty($tipof)){
        ...
        while($SAL = mysqli_fetch_row($valor)){
            ...
            $canTemp = "SELECT  COUNT(DISTINCT e.id_unico), t.razonsocial 
                        ...
                        WHERE c.tipofondo = 1  AND c.clase = 2 AND t.numeroidentificacion = '$SAL[0]' AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND vr.estado=1 AND vr.vinculacionretiro IS NULL 
                        OR c.tipofondo = 1  AND c.clase = 2 AND t.numeroidentificacion = '$SAL[0]' AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND vr.estado = 2 AND vr.fecha BETWEEN '$retE[0]' AND '$retE[1]'";
            ...
            $vemple = "SELECT   c.id_unico, 
                    ...
                    LEFT JOIN gf_tercero t ON af.tercero = t.id_unico 
                    LEFT JOIN gn_periodo p ON p.id_unico=n.periodo
                    WHERE c.tipofondo = 1 AND c.clase = 2   AND t.numeroidentificacion = '$SAL[0]'  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' GROUP BY t.numeroidentificacion";
            ...
            $vpat = "SELECT     c.id_unico, 
                    ...
                    LEFT JOIN gf_tercero t ON af.tercero = t.id_unico 
                    LEFT JOIN gn_periodo p ON p.id_unico=n.periodo
                    WHERE c.tipofondo = 1  AND c.clase = 7 AND t.numeroidentificacion = '$SAL[0]' AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' GROUP BY t.numeroidentificacion";
            ...
            $VTot = "SELECT SUM(n.valor), t.razonsocial FROM gn_novedad n 
                ...
                LEFT JOIN gf_tercero t ON af.tercero = t.id_unico
                LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                WHERE c.tipofondo = 1  AND t.numeroidentificacion = '$SAL[0]' AND c.clase != 6 AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'";
        ...
        $Fsal1 = $mysqli->query($canTemp1);
        $CanE1 = mysqli_fetch_row($Fsal1);
        $pdf->cellfitscale($mc2,5,utf8_decode($tot),0,0,'R');
        ...
        $ToEM = "SELECT     c.id_unico, 
                ...
                LEFT JOIN gf_tercero t ON af.tercero = t.id_unico 
                LEFT JOIN gn_periodo p ON p.id_unico=n.periodo
                WHERE c.tipofondo = 1 AND c.clase = 2  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'";
        ...
        $vpat1 = "SELECT    c.id_unico, 
                ...
                LEFT JOIN gf_tercero t ON af.tercero = t.id_unico 
                LEFT JOIN gn_periodo p ON p.id_unico=n.periodo
                WHERE c.tipofondo = 1  AND c.clase = 7  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'";
        ...
        $VTot1 = "SELECT SUM(n.valor), t.razonsocial FROM gn_novedad n 
              ...
              LEFT JOIN gf_tercero t ON af.tercero = t.id_unico 
              LEFT JOIN gn_periodo p ON p.id_unico=n.periodo
              WHERE c.tipofondo = 1  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'
               AND c.clase != 6 ";
        ...
        while($PEN = mysqli_fetch_row($valor1)){
            ...
            $canTemp = "SELECT  COUNT(DISTINCT e.id_unico) FROM gn_novedad n
                        ...
                        LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                        LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                        WHERE t.numeroidentificacion = '$PEN[0]' AND af.tipo = 2 AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'  AND vr.estado=1 AND vr.vinculacionretiro IS NULL 
                        OR t.numeroidentificacion = '$PEN[0]' AND af.tipo = 2 AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND vr.estado = 2 AND vr.fecha BETWEEN '$retE[0]' AND '$retE[1]'";            
            ...
            $vemple = "SELECT   c.id_unico, 
                        ...
                        LEFT JOIN gf_tercero t ON af.tercero = t.id_unico
                        LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                        WHERE c.tipofondo = 2  AND c.clase = 2 AND c.id_unico !=81  AND t.numeroidentificacion = '$PEN[0]'  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'
                        GROUP BY t.numeroidentificacion";
            ...
            $vpat = "SELECT     c.id_unico, 
                    ...
                    LEFT JOIN gf_tercero t ON af.tercero = t.id_unico 
                    LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                    WHERE c.tipofondo = 2  AND c.clase = 7 AND t.numeroidentificacion = '$PEN[0]'  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'
                     GROUP BY t.numeroidentificacion";
            ...
            $VTot = "SELECT SUM(n.valor), t.razonsocial FROM gn_novedad n 
                ...
                LEFT JOIN gf_tercero t ON af.tercero = t.id_unico 
                LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                WHERE c.tipofondo = 2  AND t.numeroidentificacion = '$PEN[0]' AND c.clase != 6 AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'";
        ...
        $Fsal1 = $mysqli->query($canTemp1);
        $CanE1 = mysqli_fetch_row($Fsal1);
        $pdf->cellfitscale($mc2,5,utf8_decode($totP),0,0,'R');
        ...
        $vemple1 = "SELECT  c.id_unico, 
                    ...
                    LEFT JOIN gf_tercero t ON af.tercero = t.id_unico 
                    LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                    WHERE c.tipofondo = 2  AND c.clase = 2 AND c.id_unico !=81  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' ";
        ...
        $vpat1 = "SELECT    c.id_unico, 
                ...
                LEFT JOIN gf_tercero t ON af.tercero = t.id_unico 
                LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                WHERE c.tipofondo = 2  AND c.clase = 7  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'";
        ...
        $VTot12 = "SELECT SUM(n.valor) FROM gn_novedad n 
                ...
                LEFT JOIN gf_tercero t ON af.tercero = t.id_unico 
                LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                WHERE c.tipofondo = 2  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'
                 AND c.clase != 6 ";
        ...
        while($AR = mysqli_fetch_row($valor2)){
            ...
            $canTemp = "SELECT  COUNT(DISTINCT e.id_unico) FROM gn_novedad n
                        ...
                        LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                        LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                        WHERE t.numeroidentificacion = '$AR[0]' AND af.tipo = 4 AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'  AND vr.estado=1 AND vr.vinculacionretiro IS NULL 
                        OR t.numeroidentificacion = '$AR[0]' AND af.tipo = 4 AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND vr.estado = 2 AND vr.fecha BETWEEN '$retE[0]' AND '$retE[1]'";
            ...
            $vpat = "SELECT sum(n.valor) FROM gn_novedad n
                    ...
                    LEFT JOIN gf_tercero t ON af.tercero = t.id_unico
                    LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                    WHERE p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND concepto =363 AND t.numeroidentificacion = '$AR[0]'";
            $vapa = $mysqli->query($vpat);
            $valP = mysqli_fetch_row($vapa);
        ...
        $vpat1 = "SELECT sum(n.valor) FROM gn_novedad n
        LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
         WHERE p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND concepto =363";
        $vapa1 = $mysqli->query($vpat1);
        $valP1 = mysqli_fetch_row($vapa1);
        ...
        while($AR = mysqli_fetch_row($valor2)){
            ...
            $canTemp = "SELECT  COUNT(DISTINCT e.id_unico) FROM gn_novedad n
                        ...
                        LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                        LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                        WHERE t.numeroidentificacion = '$AR[0]' AND af.tipo = 6 AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]'  AND vr.estado=1 AND vr.vinculacionretiro IS NULL 
                        OR t.numeroidentificacion = '$AR[0]' AND af.tipo = 6 AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND vr.estado = 2 AND vr.fecha BETWEEN '$retE[0]' AND '$retE[1]'";
            ...
            $vpat = "SELECT sum(n.valor) FROM gn_novedad n
                    ...
                    LEFT JOIN gf_tercero t ON af.tercero = t.id_unico
                    LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                    WHERE  p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND concepto =256 AND t.numeroidentificacion = '$AR[0]'";
            $vapa = $mysqli->query($vpat);
            $valP = mysqli_fetch_row($vapa);
        ...
        $vpat1 = "SELECT sum(n.valor) FROM gn_novedad n
        LEFT JOIN gn_periodo p ON p.id_unico=n.periodo  WHERE p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND concepto =256";
        $vapa1 = $mysqli->query($vpat1);
        ...
        while($PAR = mysqli_fetch_row($valor2)){
            ...
            $canTemp = "SELECT COUNT(DISTINCT n.empleado) FROM gn_novedad n 
                        ...
                        LEFT JOIN gn_vinculacion_retiro vr ON vr.empleado = e.id_unico
                        LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                        WHERE t.id_unico = '$PAR[0]'  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND vr.estado=1 AND vr.vinculacionretiro IS NULL 
                        OR t.id_unico = '$PAR[0]'  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND vr.estado = 2 AND vr.fecha BETWEEN '$retE[0]' AND '$retE[1]'";
            ...
            $vpat = "SELECT SUM(n.valor) FROM gn_novedad n 
                    ...
                    LEFT JOIN gn_empleado e ON n.empleado = e.id_unico 
                    LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                    WHERE t.id_unico = '$PAR[0]'  AND p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND c.clase = 7";
        ...
        $vpat1 = "SELECT SUM(n.valor) FROM gn_novedad n 
                ...
                LEFT JOIN gn_empleado e ON n.empleado = e.id_unico 
                LEFT JOIN gn_periodo p ON p.id_unico=n.periodo 
                WHERE   p.fechainicio BETWEEN '$retE[0]' AND '$retE[1]' AND p.fechafin BETWEEN '$retE[0]' AND '$retE[1]' AND c.tipoentidadcredito IS NOT NULL AND c.clase = 7 AND n.concepto !=363 AND n.concepto !=256 ";
