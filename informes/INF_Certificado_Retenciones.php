...
LEFT JOIN 
  gf_ciudad ci ON ci.id_unico=t.ciudadidentificacion
LEFT JOIN 
  gf_departamento dep ON dep.id_unico=ci.departamento
WHERE
  t.id_unico =$compa";
...
{ 
    ...
    $this->ln(5);
    $this->SetFont('Arial','',10);
    $this->Cell(80,10,utf8_decode('Ciudad:'),0,0,'L');
    $this->SetFont('Arial','B',10);
    $this->Cell(110,10,utf8_decode($ciudad),0,0,'L');
    $this->ln(5);
    $this->SetFont('Arial','',10);
    $this->Cell(80,10,utf8_decode('Departamento:'),0,0,'L');
    $this->SetFont('Arial','B',10);
    $this->Cell(110,10,utf8_decode($departamento),0,0,'L');
    $this->ln(10);
    $this->SetFont('Arial','',10);
    ...
    $this->SetFont('Arial','B',10);
    $this->Cell(190,10,utf8_decode('HEMOS RETENIDO A:'.$terceroI.'and'.$terceroF),0,0,'C');
    $this->ln(10);
    }      
