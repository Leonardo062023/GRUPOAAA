    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
        <thead>
            ...
            <tr>
                ...
                <th align="center">CONTEO FISICO</th>
            </tr>
        </thead>
        <tbody>
        <?php
        ...
        foreach ($dat as $row){
            ...
            if($xsaldo > 0){
                ...
                $html .= "<td style='text-align: center;'>".mb_strtoupper($row[2])."</td>";
                $html .= "<td style='text-align: center;'>$row[3]</td>";
                $html .= "<td style='text-align: center;'>$xsaldo</td>";
                $html .= "<td style='text-align: center;'>".number_format($xvalor, 2 , ',', '.')."</td>";
        ...
        <tfoot>
            ...
            <tr>
                <th colspan="6" style="text-align: center;"><br>____________________________________<br>Firma Responsable de Almacen</th>
