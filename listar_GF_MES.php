...
switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT m.id_unico, m.mes, m.numero, em.nombre FROM gf_mes m LEFT JOIN gf_estado_mes em ON m.estadomes = em.id_unico 
                            ...
                            <table id="tabla" class="table table-stripe table-condensed display" cellpadding="0" width="100%">
                                ...
                                for ($i=0; $i <count($row) ; $i++) {?> 
                                    <tr>
                                        ...
                                        <td class="campos">
                                            <a class="campos" href="#" onclick="eliminarFormato(<?php echo $row[$i][0]; ?>)">
                                                <i title="Eliminar" class="glyphicon glyphicon-trash"></i>
                                            </a>
                                            <a class="campos" href="modificar_GF_MES.php?id=<?php echo md5($row[$i][0]); ?>">
