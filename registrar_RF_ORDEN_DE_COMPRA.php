                    ...
                    <div style="margin-top:-7px; border: 4px solid #020324; border-radius: 10px; margin-right: 4px;" class="client-form">
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="controller/controllerGFOrdenCompraAlmacen.php?action=insert" style="margin-bottom: -30px;margin-left: 10px">
                            ...
                            <div class="form-group form-inline" style="margin-top: 5px;">
                                ...
                                <input type="text" name="txtFecha" id="txtFecha" title="Ingrese la fecha" style="width: 10%" class="col-lg-1 col-sm-1 form-control" placeholder="Fecha" required readonly value="<?php echo $fecha; ?>" onchange="">
                                ...
                                <select name="sltDependencia" id="sltDependencia" title="Seleccione dependencia" style="width: 10%" class="col-lg-1 col-sm-1 form-control select2" required>
                                    ...
                                    if (!empty($dependencia)) {
                                        ...
                                        $sql10 = "SELECT DISTINCT id_unico,nombre 
                                            FROM gf_dependencia WHERE id_unico != $dependencia AND compania = $compania AND (movimiento =0 OR activa = 0) 
                                        ...
                                        $sql11 = "SELECT DISTINCT id_unico,nombre FROM gf_dependencia 
                                            WHERE compania = $compania AND (movimiento =0 OR activa = 0) #AND tipodependencia != 1";
                ...
                <div class="col-lg-10 col-sm-10 text-left" style="margin-top: 5px">
                    <form name="form" id="formD" class="form-horizontal" method="POST" enctype="multipart/form-data" action="controller/controllerGFMovimiento.php?action=insert_detail">
                        <div class="form-group">
                            ...
                            <input type="text" name="txtCantidad" class="form-control col-lg-1 col-sm-1" id="txtCantidad" title="Cantidad" onkeypress="return txtValida(event, 'dec', 'txtCantidad', '2');" maxlength="10" placeholder="Cantidad" style="padding:2px;width:80px;font-size: 10px;"/>
                            <label class="control-label col-lg-1 col-sm-1"><strong class="obligado">*</strong>Valor:</label>
                            <input type="text" name="txtValor" id="txtValor" class="form-control col-lg-1 col-sm-1" title="Valor aproximado" onkeypress="return txtValida(event, 'dec', 'txtValor', '2');" maxlength="50" placeholder="Valor" style="padding:2px;width:110px;font-size: 10px;"/>
                            <label class="control-label col-lg-1 col-sm-1"><strong class="obligado">*</strong>Iva:</label>
                            <input type="text" name="txtValorIva" id="txtValorIva" class="form-control col-lg-1 col-sm-1" title="Iva" onkeypress="return txtValida(event, 'dec', 'txtValorIva', '2');" maxlength="50" placeholder="Iva" style="padding:2px;width:100px;font-size: 10px;margin-right: 10px" readonly/>
                            ...
                            <input type="text" name="txtValorTotal" id="txtValorTotal"  class="form-control col-lg-1 col-sm-1" title="Valor total" onkeypress="return txtValida(event, 'dec', 'txtValorTotal', '2');"  maxlength="50" placeholder="Valor Total" style="padding:2px;width:100px;font-size: 10px;margin-right: 10px" required="" readonly/>
