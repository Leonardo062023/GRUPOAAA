                    ...
                    <div class="table-responsive contTabla">
                        <table id="tabla" class="table table-striped table-condensed display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="oculto"><?php echo $$listar[$i][0]; ?></td>
                                    <td class="campos">
                                        <a href="#" onclick="javascript:eliminar(<?php echo $listar[$i][0]; ?>);">
                                            <li title="Eliminar" class="glyphicon glyphicon-trash"></li>
                                        </a>
                                        <a href="EDITAR_TERCERO_PROVEEDOR_NATURAL_2.php?action=1&id=<?php echo base64_encode($listar[$i][0]); ?>">
                                            <li title="Modificar" class="glyphicon glyphicon-edit"></li>
                                        </a>
                                    </td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($listar[$i][2])); ?></td>
                                    <td class="campos"><?php echo ucwords(($listar[$i][3])); ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($listar[$i][4])); ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($listar[$i][5])); ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($listar[$i][6])); ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($listar[$i][7])); ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($listar[$i][9])); ?></td>
                                    <td class="campos"><?php echo $listar[$i][10]; ?></td>
                                </tr> 
                                <?php } ?>                                    
                            </tbody>
                        </table>
                        ...
                        <div class="form-group form-inline col-sm-6" style="">
                            <div align="right">
                                <a href="EDITAR_TERCERO_PROVEEDOR_NATURAL_2.php?action=2" class="btn btn-primary btnNuevoLista" Style="box-shadow: 0px 2px 5px 1px gray;color: #fff;border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px;">Registrar Nuevo</a>
                            </div> 
                        </div> 
                    </div>                        
                </div>
