...
<style>
    ...
    .sombra {
        box-shadow: 1px 2xp 1px 2px gray;
    }
</style>  
...
<?php require_once('menu.php'); ?> 
            ...
            <div class="col-sm-10 text-center" style="margin-top:-22px;">
                ...
                <h2 class="tituloform" align="center" >Comprobante <?php
                    if (!empty($_SESSION['idCompCntV'])) {
                        echo ucwords(mb_strtolower($rowTC[0]));
                    }
                    ?></h2>
                ...
                WHERE id_unico = $idComprobante";
                                ...
                                <textarea class="col-sm-2" style="margin-left: 0px; margin-top: 0px; margin-bottom: 5px; width:250px; height: 50px; width:170px" class="area" rows="2" name="descripcion" id="descripcion"  maxlength="500" placeholder="Descripción"   ><?php
                                if (!empty($_SESSION['idCompCntV'])) {
                                    echo (($rowDesCnt[0]));
                                }
                            ...
                            <div class="col-sm-3" align="left"> <!-- Tipo Comprobante -->
                                ...
                                <input name="tipoComprobante" id="tipoComprobante" class="form-control input-sm" title="Tipo Comprobante" style="width:180px;" value="<?php
                                if (!empty($_SESSION['idCompCntV'])) {
                                    echo ucwords(mb_strtolower($rowTC[0]));
                                }
                                ?>" readonly >
                            ...
                            <div class="col-sm-3" align="left"> <!-- Número -->
                                ...
                                <input name="numeroCnt" id="numeroCnt" class="form-control input-sm" title="Número Comprobante" style="width:180px;" value="<?php
                                if (!empty($_SESSION['idCompCntV'])) {
                                    echo ucwords(mb_strtolower($rowNC[0]));
                                }
                                ?>" readonly >
                            ...
                            <div class="col-sm-4" align="left"> <!-- Tipo Contrato-->
                                ...
                                <select name="claseContrato" id="claseContrato" class="form-control input-sm" title="Clase Contrato" style="width:150px;">
                                    <?php if (!empty($sgf[1])) { ?>
                                        ...
                                        <?php
                                        $clasecon = "SELECT id_unico, nombre FROM gf_clase_contrato WHERE id_unico != '$sgf[1]' ORDER BY nombre ASC ";
...
<?php } ?>
                        ...
                        <div class="form-group form-inline col-sm-3" style="margin-top: -30px"> <!-- Botones --> 
                            ...
                            <div class="col-sm-3" style="margin-top: 19px;">
                                <button type="button" class="btn btn-primary sombra" style="background: #00548F; color: #fff; border-color: #1075C1; margin: 0 auto;" title="Firma Dactilar" id="firmaD" onclick="firma();"><img src="images/hb2.png" style="width: 14px; height: 17.28px"></button> <!--Firma Dactilar-->
                            </div>    
...
?>
                        ...
                        <div class="form-group form-inline col-sm-3" style="margin-top: -30px"> <!-- Botones --> 
                            <div class="col-sm-3" style="margin-top: 19px; "> <!-- Botón siguiente -->
                        ...
                        <div class="modal fade" id="mdlAgregarCuentaC" role="dialog" align="center" >
                            <div class="modal-dialog" >
                                <div class="modal-content">
                                    ...
                                    <form name="formCta" id="formCta" accept-charset=""class="form-horizontal" method="POST"  enctype="multipart/form-data" action="guardarCuenta">
                                        <div class="modal-body" style="margin-top: 8px">
    ...
    ?>
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group" style="margin-top: 5px;" >
                                                ...
                                                <select name="sltcentroc" id="sltcentroc" class="select2_single form-control" style="display:inline-block; width:250px; margin-bottom:15px; height:40px" title="Seleccione centro costo" required="">
                                                    ...
                                                    <?php while ($fila2 = mysqli_fetch_row($r)) { ?>
                                            ...
                                            <div class="form-group" style="margin-top: 5px;" >
                                                ...
                                                ?>
                                                    ...
                                                    <?php while ($fila3 = mysqli_fetch_row($X)) { ?>
                        ...
                        <script>
                            function guardarCuentaContable() {
                                var formData = new FormData($("#formCta")[0]);
                                $.ajax({
                                    type: 'POST',
                                    ...
                                    <tr>
                                        ...
                                        <td class="campos">
                                            ...
                                            if (!empty($_SESSION['idCompCntV'])) {
                                                ...
                                                $fc = "SELECT fecha FROM gf_comprobante_cnt WHERE id_unico = $idComprobante";
                                                $fc = $mysqli->query($fc);
                                        ...
                                        <td class="campos text-left" >
                                            ...
                                            <div id="sltC<?php echo $row[0]; ?>" style="display:none">
                                                <select id="sltCuenta<?php echo $row[0]; ?>" style="display: none; padding: 2px;height:18; width: 150px" class="select2_single col-sm-12 campoD" onclick="asigSelect('sltCuenta',<?= $row[0] ?>)">
                                                    <option value="<?php echo $row[1]; ?>"><?php echo $row[3] . '-' . $row[2]; ?></option>
                                                    <?php
                                                    $sqlCTN = "SELECT DISTINCT id_unico,"
                                                            . "codi_cuenta,nombre "
                                                            . "FROM gf_cuenta WHERE parametrizacionanno = $anno and (codi_cuenta != $row[3]) 
                                                                                        AND (movimiento = 1
                                                                                        OR      centrocosto = 1
                                                                                        OR      auxiliartercero = 1
                                                                                        OR      auxiliarproyecto = 1) "
                                        ...
                                        <td class="campos text-left">
                                            ...
                                            <div id="sltTercero<?php echo $row[0]; ?>" style="display:none">
                                                <select id="stTercero<?php echo $row[0]; ?>" style="display: none; padding: 2px;height:18; width: 150px" class="col-sm-12 campoD" onclick="cargarT(<?= $row[0] ?>)">
                                        ...
                                        <td class="campos text-left">
                                            ...
                                            <div id="sltCentro<?php echo $row[0]; ?>" style="display:none">
                                                <select id="sltcentroC<?php echo $row[0]; ?>" style="display: none; padding: 2px;height:18; width: 150px" class="select2_single col-sm-12 campoD" onclick="asigSelect('sltcentroC',<?= $row[0]?>)" >
                                        ...
                                        <td class="campos text-left">
                                            ...
                                            <div id="sltProyectoD<?php echo $row[0]; ?>" style="display:none">
                                                <select id="sltProyecto<?php echo $row[0]; ?>" style="display: none; padding: 2px;height:18; width: 150px" class="select2_single col-sm-12 campoD" onclick="asigSelect('sltProyecto',<?=$row[0];?>)">
                                            <?php
                                            if (empty($row[12])) {
                                                echo '<option value="">Proyecto</option>';
                                            } else {
                                                echo '<option value="' . $row[12] . '">' . ucwords(mb_strtolower($row[13])) . '</option>';
                                            }
                                            ?>

                                            <?php
                                            $sqlCP = "SELECT DISTINCT id_unico,nombre FROM gf_proyecto WHERE id_unico != '$row[12]' AND compania = $compania";
...
?>
                ...
                <script>
                    function modificar1(id) {
                        ...
                        if (($("#idPrevio").val() != 0) || ($("#idPrevio").val() != ""))
                        {
                            ...
                            var centro = 'sltCentro' + $("#idPrevio").val();
                            var centrolbl = 'centroC' + $("#idPrevio").val();

                            var proyecto = 'sltProyectoD' + $("#idPrevio").val();
                            var proyectolbl = 'proyecto' + $("#idPrevio").val();
                        ...
                        var centro = 'sltCentro' + id;
                        var centrolbl = 'centroC' + id;

                        var proyecto = 'sltProyectoD' + id;
                        var proyectolbl = 'proyecto' + id;

                        console.log(id + 'Modificar' + debito + debitolbl);

                        $("#sltC" + id).css("display", "block");
                        $("#sltCuenta" + id).css("display", "block");
                        $("#sltTercero" + id).css("display", "block");
                        $("#stTercero" + id).css("display", "block");
                        $("#sltcentroC" + id).css("display", "block");
                        $("#sltProyecto" + id).css("display", "block");
                        ...
                        $("#" + centrolbl).css("display", "none");

                        $("#" + proyecto).css("display", "block");
                        $("#" + proyectolbl).css("display", "none");
                ...
                <script>
                    function guardarCambios(id) {
                        ...
                        var cuenta = document.getElementById('sltCuenta' + id).value;
                        var centroC = document.getElementById('sltcentroC' + id).value;
                        var centroC = document.getElementById('sltcentroC' + id).value;
                        if (valorD == '' || valorD == 0) {
                            if (valorC == '' || valorC == 0) {
                ...
                <script>
                    function guardarg(id) {
                        ...
                        var cuenta = document.getElementById('sltCuenta' + id).value;
                        var centroC = document.getElementById('sltcentroC' + id).value;
                        var proyecto = document.getElementById('sltProyecto' + id).value;
                        if (valorD == '' || valorD == 0) {
                        ...
                        var tercero = document.getElementById('stTercero' + id).value;
                        ...
                        $.ajax({
                            ...
                            {  
                                ...
                                //GUARDAR VALOR   
                                var form_data = {iddetalle: id, centro: centroC, valorD: valorD, valorC: valorC, tercero: tercero, cuenta: cuenta, proyecto: proyecto};
                                $.ajax({
                                    type: "POST",
                                    ...
                                    success: function (response)
                                    {
                                        console.log(response+'modfcnt '+tercero);
                                        if (response == 1) {
...
<?php } else { ?>
                            <label class="control-label text-right valores" title="Diferencia"><?php echo $diferencia; ?></label>
    ...
    <div class="modal fade" id="myModal1" role="dialog" align="center" >
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div id="forma-modal" class="modal-footer">
                    <button type="button" id="ver1" class="btn" style="color: #000; margin-top: 2px" data-dismiss="modal" onclick="javascript:cerrar()" >Aceptar</button>
                </div>
            </div>
        </div>
    </div>
        ...
        if (mysqli_num_rows($ci) > 0) {
            ...
            <script>
                $(document).ready(function ()
                {
                    ...
                    $("#claseContrato").prop("disabled", true);
                    $("#numeroContrato").prop("disabled", true);
                    $("#btnRetencion").css("disabled", true);
...
<script>
    ...
    function asigSelect(campo, id){
        console.log(campo+id);
        $("#"+campo+id).select2({placeholder: "", allowClear: true});
    }
</script>  
