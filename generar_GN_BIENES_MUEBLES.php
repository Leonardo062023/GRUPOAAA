    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 col-md-10 col-lg-10">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px; margin-top: 0px;">Informe De Bienes Muebles </h2>
      ...
      $(".select2").select2();
           ...
           $("#btnPdf").click(function(){
               $("#form").attr("action","informes_almacen/informes_bienes_muebles.php");
           });
