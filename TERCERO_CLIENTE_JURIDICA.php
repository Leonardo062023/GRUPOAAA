...
$resultado = $con->Listar("SELECT t.Id_Unico , t.RazonSocial , t.NumeroIdentificacion , 
            ...
            <div class="col-sm-10 text-left" style="margin-top:-20px">
                ...
                <div class="table-responsive contTabla">
                    <div class="table-responsive contTabla">
                            ...
                            <tbody>
                                <?php for ($i = 0; $i < count($resultado); $i++) { ?>
                                    <tr>
                                        ...
                                        <td class="campos">
                                            <?php if ($resultado[$i][2] == '900849655' || $resultado[$i][2] == '9999999999') {
                                            } else { ?>
                                                <a class href="#" onclick="javascript:eliminarClieJuri(<?php echo $resultado[$i][0]; ?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i>
                                                </a>
                                                <a href="modificar_TERCERO_CLIENTE_JURIDICA.php?action=1&id_ter_clie_jur=<?php echo base64_encode($resultado[$i][0]); ?>"><i title="Modificar" class="glyphicon glyphicon-edit"></i></a>
                                            <?php } ?>
                                        </td>
                                        ...
                                        <td class="campos">
                                            <?php if (!empty($resultado[$i][6])) {
                                                ...
                                                FROM gf_tercero ter WHERE ter.Id_Unico = $auxidwowl");


                                                echo ucwords(mb_strtolower($rowRL[0][1] . " " . $rowRL[0][2] . " " . $rowRL[0][3] . " " . $rowRL[0][4])) . ' - ' . $rowRL[0][5];
                                            } ?>
                                        </td>
                                        <td class="campos"><?php echo ($resultado[$i][7] . ' - ' . $resultado[$i][14]) ?></td>
                                        <td>
                                            <?php if (!empty($resultado[$i][9])) {
                                                $auxidwowl = $resultado[$i][9];
                        ...
                        <div class="form-group form-inline col-sm-6" style="">
                            <div align="right">
                                <a href="modificar_TERCERO_CLIENTE_JURIDICA.php?action=2" class="btn btn-primary btnNuevoLista" Style="box-shadow: 0px 2px 5px 1px gray;color: #fff;border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px;">Registrar Nuevo</a>
                            </div>
                        </div>
                    </div>
                </div>
