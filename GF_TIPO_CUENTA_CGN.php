...
switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_tipo_cuenta_cgn");
    break;
    case '2':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_tipo_cuenta_cgn");
    break;
          ...
          <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
            ...
            <?php
               ...
               <tr>
                ...
                <td>
                  <a class"" href="#" onclick="javascript:eliminarTipoCuen(<?php echo $row[$i][0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a>

                  <a href="modificar_GF_TIPO_CUENTA_CGN.php?id_tipo_cuen=<?php echo ($row[$i][0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                </td>
      ...
      function eliminarTipoCuen(id)
      {
        $("#myModal").modal('show');
                        $("#ver").click(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificar_GF_TIPO_CUENTA_CGNJson.php?action==1",
                                data: form_data,
