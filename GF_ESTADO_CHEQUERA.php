<?php 
 ...
 ?>
	<title>Registrar Estado Chequera</title>
</head>
<body>
	<div class="container-fluid text-center">
		...
		<div class="row content">
			...
			<div class="col-sm-10 text-left">
				...
				<h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;"">Registrar Estado Chequera</h2>
	...
	<script>
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarEstadoChequeraJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
