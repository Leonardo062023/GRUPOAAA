...
if (isset($_GET["id"])){ 
  ...
  switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_naturaleza WHERE (Id_Unico) = '$id'");
    break;
    case '2':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_naturaleza WHERE (Id_Unico) = '$id'");
  break;
...
<title>Modificar Naturaleza</title>
</head>
<body>
...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-10 text-left">
      ...
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Modificar Naturaleza</h2>
      ...
      <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="javascript:modificar()">
          ...
          <p align="center" style="margin-bottom: 25px; margin-top: 25px; margin-left: 30px; font-size: 80%">Los campos marcados con <strong style="color:#03C1FB;">*</strong> son obligatorios.</p>
            ...
            <input type="hidden" name="id" value="<?php echo $row[$i][0]?>">
              ...
              <!--Cargar los datos para la modifcación-->
...
<script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarNaturaleza.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
