            ...
            <div class="col-sm-10 col-md-10 col-lg-10">
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form name="form" id="form" class="form-horizontal" method="POST" target="_selft" enctype="multipart/form-data" action="">
                        ...
                        <div class="form-group">
                            <label for="sltTipo" class="control-label col-sm-5 col-md-5 col-lg-5"><strong class="obligado">*</strong>Tipo de Producto:</label>
                            <div class="col-sm-5 col-md-5 col-lg-5">
                                <select name="sltTipo" id="sltTipo" class="select2 form-control text-left" required="">
                                    <?php
                                    $html= "";
                                    $html.= "<option value=\"\">Tipo Producto</option>";
                                    $html.= "<option value=11>Todos los tipos</option>";
                                    $sqlp = "SELECT id_unico,nombre FROM gf_tipo_inventario
                                             WHERE id_unico in (2,3)";
                                    $resp = $mysqli->query($sqlp);
                                    while($rowp = mysqli_fetch_row($resp)){
                                        $html.= "<option value=\"$rowp[0]\">".ucwords(mb_strtolower($rowp[1]))."</option>";
                                    }
