...
<script>
   ...
   <title>Liquidación Bonificación Territorial</title>
    <link rel="stylesheet" href="css/select2.css">
    <link rel="stylesheet" href="css/select2-bootstrap.min.css"/>
</head>
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left" style="margin-top: 0px">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Liquidación Bonificación Territorial</h2>
                    ...
                    <div class="client-form contenedorForma" style="margin-top: -7px;font-size: 13px">
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/LiquidarBonTerJson.php">
                            ...
                            <div class="form-group form-inline" style="margin-top:-25px">
                                ...
                                <?php
                                    $per = "SELECT  p.id_unico, CONCAT(p.codigointerno,' - ',tpn.nombre) 
                                            ...
                                            WHERE p.liquidado !=1 AND p.tipoprocesonomina = 5 AND p.parametrizacionanno = '$vig'";
