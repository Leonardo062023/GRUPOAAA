                    ...
                    if(!empty($_POST['ficha'])){
                        ...
                        if($x==$existencias){ ?>
                            <script type="text/javascript">
                                ...
                                $.ajax({
                                    type: 'POST',
                                    url: "consultasBasicas/paginacionFormularioProducto1.php",
                                    data: form_data,
                         ...
                         <form name="form" id="formProducto" class="form-horizontal col-sm-10 col-lg-10" method="POST"  enctype="multipart/form-data" action="json/registrarProductoEspecificacionMov.php" >
                            <div style="margin-top:-20px;" class="client-form">
                                ...
                                <div class="form-group form-inline" style="margin-top:5px;">
                                    ...
                                    $vFicha ="";
                                    $valorE = "";
                                    $requeridos ="txtValorProducto,txtDescripcionProducto";
                                    ...
                                    if (!empty($_POST['ficha'])) {
                                        ...
                                        echo '<input type="hidden" class="hidden" name="val1" id="val1" value="0">';
                                            ...
                                            switch ($campo[4]) {
                                                case 1:
                                                    if($campo[8] == 1){
                                                        ...
                                                        if($campo[7] == 1){
                                                            $requeridos .=",".str_replace(' ', '', $campo[3]);
                                    ...
                                    <input  onkeypress="return txtValida(event,'num')" type="text" name="txtValorProducto" value="<?php echo $valorE;?>" id="txtValorProducto" class="form-control col-lg-1 col-sm-1 input-sm" maxlength="150" title="Ingrese el valor" placeholder="Valor" required >
                                    <label class="control-label col-lg-4 col-sm-4"><strong class="obligado">*</strong>Descripción:</label>
                                    <input class="form-control col-lg-1 col-sm-1 area" style="width:300px;margin-top:-1px;height:40px" rows="2" onkeypress="return txtValida(event,'num_car');" maxlength="500" minlength="0" name="txtDescripcionProducto" id="txtDescripcionProducto" title="Descripción del producto" required="required">
                                    <input type="hidden" class="hidden" name="requeridos" id="requeridos" value="<?php echo  $requeridos;?>">
                                    <br/>
                                    <label  class="control-label col-lg-8 col-sm-8" id="error" style="color: red;text-align: left;margin-left: 200px;"><strong class="obligado"></strong></label>
                                    <div class="col-sm-7" id="btnGuardarP">
                                        ...
                                        function generarJson(form){
                                            ...
                                            for (var i = 0 in arreglo) {
                                                ...
                                                if($("#"+arreglo[i]).val()==""){
                                                    ...
                                                    if(arreglo[i]=='txtValorProducto'){
                                                        console.log($("#"+arreglo[i]).val());
                                                        $nre += 'Valor Campo Requerido* <br/>';    
                                                    } else {
                                                        if(arreglo[i]=='txtDescripcionProducto'){
                                                            $nre += 'Descripción Campo Requerido* <br/>';    
                                                        } else {
                                                            $nre += arreglo[i] + ' Campo Requerido* <br/>';        
                                                        }
                                                    }
                                                    $nrq +=1;
                                                }
