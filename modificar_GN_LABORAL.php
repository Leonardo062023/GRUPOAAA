...
<!------------------------- Consulta para llenar campo Entidad-->
            <div class="form-group" style="margin-top: -5px">
                ...
                <input type="text" name="sltEntidad" id="sltEntidad"  value="<?php echo $entL?>"class="form-control" maxlength="100" title="Ingrese la entidad"  placeholder="Entidad" required="" >
