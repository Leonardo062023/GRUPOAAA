...
switch ($action){
    ...
    case 3:
        ...
        $ms =  "SELECT DISTINCT id_unico, codi_presupuesto, "
             ...
             . "FROM gf_rubro_pptal WHERE  parametrizacionanno = $annio AND (tipoclase = 7  OR tipoclase = 9 OR tipoclase = 10 ) "
...
function anno($id){
    global $con;
    $sql= $con->Listar("SELECT anno FROM gf_parametrizacion_anno WHERE id_unico = $id");
    $anno = $sql[0][0];
    return ($anno);
}