            ...
            <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action=""  target=”_blank”>  
                    ...
                    <div class="form-group">
                        ...
                        <!--TERCERO-->
                        <?php $ti= "SELECT DISTINCT IF(CONCAT_WS(' ',
                                    tr.nombreuno,
                                    tr.nombredos,
                                    tr.apellidouno,
                                    tr.apellidodos) 
                                    ...
                                    FROM gf_detalle_comprobante_pptal  cp 
                                    LEFT JOIN gf_tercero tr  ON cp.tercero = tr.id_unico 
                                    WHERE tr.compania = $compania  ORDER BY tr.numeroidentificacion ASC";
                        ...
                        <?php $tf= "SELECT DISTINCT IF(CONCAT_WS(' ',
                                    tr.nombreuno,
                                    tr.nombredos,
                                    tr.apellidouno,
                                    tr.apellidodos) 
                                    ...
                                    FROM gf_detalle_comprobante_pptal  cp 
                                    LEFT JOIN gf_tercero tr  ON cp.tercero = tr.id_unico 
                                    WHERE tr.compania = $compania ORDER BY tr.numeroidentificacion DESC";
