...
if(empty($_GET['t'])){
    ...
    $row        = $con->Listar("SELECT * FROM gp_tipo_cartera WHERE id_unico=$id");
    $t2         = $row[0][1];
}
?>
                                    ...
                                    <?php for ($i = 0; $i < count($row); $i++) { ?>
                                        <tr>
                                            ...
                                            <td class="campos">
                                                ...
                                                <a class="campos" href="GP_TIPO_CARTERA.php?t=2&id=<?php echo base64_encode($row[$i][0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                                            </td>
