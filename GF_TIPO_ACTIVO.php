...
switch ($_SESSION['conexion']) {
  case '1':
    $row = $con->Listar("SELECT Id_Unico, Nombre, Valor FROM gf_tipo_activo");
    break;
  case '2':
    $row = $con->Listar("SELECT Id_Unico, Nombre, Valor FROM gf_tipo_activo");
    break;
...
?>
<title>Listar Tipo Activo</title>
</head>
  ...
  <div class="container-fluid text-center">
    <div class="row content">
      ...
      <div class="col-sm-10 text-left">
        ...
        <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Tipo Activo</h2>
        ...
        <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
          <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
              ...
              <tbody>
                ...
                for ($i = 0; $i < count($row); $i++) { ?>
                  <tr>
                    ...
                    <td>
                      <a class"" href="#" onclick="javascript:eliminarTipoActivo(<?php echo $row[$i][0]; ?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a>

                      <a href="modificar_GF_TIPO_ACTIVO.php?id_tipo_activo=<?php echo ($row[$i][0]); ?>"><i title="Modificar" class="glyphicon glyphicon-edit"></i></a>
                    </td>
            ...
            <div align="right"><a href="registrar_GF_TIPO_ACTIVO.php" class="btn btn-primary" style="box-shadow: 0px 2px 5px 1px gray;color: #fff; 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="margin-top: 8px">
          <p>¿Desea eliminar el registro seleccionado de Tipo Activo?</p>
        </div>
  ...
  <script type="text/javascript">
    function eliminarTipoActivo(id) {
      ...
      $("#ver").click(function() {
        ...
        $.ajax({
          type: 'POST',
          url: "Json/modificar_GF_TIPO_ACTIVOJson.php?action==1",
          data: form_data,
