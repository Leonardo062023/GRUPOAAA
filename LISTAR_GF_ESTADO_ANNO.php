...
switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_estado_anno ORDER BY Nombre ASC");
    break;
    case '2':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_estado_anno ORDER BY Nombre ASC");
    break;
 ...
 <body>
 	...
 	<div class="container-fluid text-center">
      ...
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Estado Año</h2> 				
               ...
               for ($i=0; $i <count($row) ; $i++) {?> 
               							<tr>
                							...
                							<td>
                								...
                								<a href="EDITAR_GF_ESTADO_ANNO.php?id=<?php echo ($row[$i][0]);?>">
 						...
 						<div align="right">
              <a href="GF_ESTADO_ANNO.php" class="btn btn-primary" 
              style="box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo
              </a> 
            </div>       
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="margin-top: 8px">
          <p>¿Desea eliminar el registro seleccionado de Estado Año?</p>
        </div>
  ...
  <script type="text/javascript">
        ...
        $("#myModal").modal('show');
                        $("#ver").click(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarEstadoAnnoJson.php?action==1",
                                data: form_data,
