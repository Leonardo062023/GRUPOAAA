                    ...
                    <div class="table-responsive contTabla">
                        <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="oculto"><?php echo $pro[$i][12] ?></td>
                                    <td class="campos"><a href="#" onclick="javascript:eliminar(<?php echo $pro[$i][12]; ?>);">
                                            <i title="Eliminar" class="glyphicon glyphicon-trash"></i>
                                        </a>
                                        <a href="EDITAR_TERCERO_PROVEEDOR_JURIDICA_2.php?action=1&id=<?php echo base64_encode($pro[$i][12]); ?>">
                                            <i title="Modificar" class="glyphicon glyphicon-edit" ></i>
                                        </a>
                                    </td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($pro[$i][1])); ?></td>
                                    <td class="campos"><?php echo $pro[$i][2] ?></td>
                                    <td class="campos"><?php echo $pro[$i][3] ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($pro[$i][4])); ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($pro[$i][5])); ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($pro[$i][6])); ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($pro[$i][7])); ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($pro[$i][8])); ?></td>
                                    <td class="campos"><?php
                                        if (!empty($pro[$i][13])) {
                                            $auxrowrl=$row[$i][13];
                                            $rowRL  =$con->Listar( "SELECT ter.Id_Unico, ter.NombreUno, 
                                                ter.NombreDos, ter.ApellidoUno, ter.ApellidoDos, ter.numeroidentificacion 
                                                FROM gf_tercero ter WHERE ter.Id_Unico = $auxrowrl");
                                           
                                           echo ucwords(mb_strtolower($rowRL[0][1] . " " . $rowRL[0][2] . " " . $rowRL[0][3] . " " . $rowRL[0][4])).' - '.$rowRL[0][5];
                                        }?>
                                    </td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($row[$i][9])); ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($row[$i][10])); ?></td>
                                    <td class="campos"><?php
                                        if (!empty($row[0][14])) {
                                            $auxrowrl=$row[$i][14];
                                            $rowRL=$con->Listar( "SELECT ter.Id_Unico, ter.NombreUno, 
                                        ...
                                        ?></td>
                                    <td class="campos"><?php echo ucwords(mb_strtolower($row[0][11])); ?></td>
                                    <td class="campos"><?php echo $row[0][15]; ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <div class="form-group form-inline col-sm-6" style="">
                            <div align="right">
                                <a href="EDITAR_TERCERO_PROVEEDOR_JURIDICA_2.php?action=2" class="btn btn-primary btnNuevoLista" Style="box-shadow: 0px 2px 5px 1px gray;color: #fff;border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px;">Registrar Nuevo</a>
                            </div> 
                        </div> 
                    </div>
                </div>
