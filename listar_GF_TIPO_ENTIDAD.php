...
switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_tipo_entidad  ORDER BY Nombre ASC");
    break;
    case '2':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_tipo_entidad  ORDER BY Nombre ASC");
    break;
            ...
            <tbody>
              ...
              <?php
               ...
               <tr>
                ...
                <td><a class"" href="#" onclick="javascript:eliminar(<?php echo $row[$i][0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a><a href="Modificar_GF_TIPO_ENTIDAD.php?id=<?php echo ($row[$i][0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a></td>
      ...
      function eliminar(id)
      {
        $("#myModal").modal('show');
                        $("#ver").click(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarTipo_Entidad.php?action==1",
                                data: form_data,
