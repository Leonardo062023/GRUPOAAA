                       ...
                       if(empty($idT))
                        ...
                        ?>
                          ...
                          <!----------------------------------------------------------------------->
                            ...
                            <select name="sltTipo" id="sltTipo" title="Seleccione Tipo Empleado" style="width: 140px;height: 30px" class="form-control col-sm-1" required>
                            ...
                            ?>
                            <select name="sltEstado" id="sltEstado" title="Seleccione Estado" style="width: 140px;height: 30px" class="form-control col-sm-1" required>
