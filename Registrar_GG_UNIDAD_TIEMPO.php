...
?>
<title>Registrar Unidad Tiempo</title>
</head>
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                ...
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Registrar Unidad Tiempo</h2>
...
<div class="modal fade" id="myModal7" role="dialog" align="center" >
  ...
  function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProcesos/registrar_GG_UNIDAD_TIEMPOJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
                                ...
                                if(response==1){
                                      ...
                                      $("#myModal6").modal('hide');
                                      document.location = 'Registrar_GG_UNIDAD_TIEMPO.php';
                                      });
                                }
                                }
                            });
