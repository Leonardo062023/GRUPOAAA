...
<body>
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">
                    <form name="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action=""  target="_blank">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 col-md-5 col-lg-5">
                            <select name="sltInforme" id="sltInforme" class="form-control select" title="Seleccione el tipo de informe" style="height: 30px" required>
                                <option value="0">Informe Completo</option>              
                                <option value="1">Informe Por Grupo</option>
                            </select>
                            </div>
                        </div>
  ...
  switch(opcion){
    ...
    break;
    case('1'):
        $('form').attr('action', 'informes/generar_INF_EXISTENCIAS_INVENTARIO_GRUPO.php');
    break;
  }   
  }
