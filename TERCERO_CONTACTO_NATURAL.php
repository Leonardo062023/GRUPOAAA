...
$resultado =$con->Listar("SELECT t.Id_Unico, ti.Nombre, t.NumeroIdentificacion, 
    t.NombreUno, t.NombreDos, t.ApellidoUno, t.ApellidoDos, 
    t.email 
  FROM gf_tercero t
  LEFT JOIN gf_tipo_identificacion ti ON t.TipoIdentificacion = ti.Id_Unico 
  LEFT JOIN gf_perfil_tercero pt ON t.Id_Unico = pt.Tercero 
  WHERE pt.Perfil = 10 AND t.compania = $compania");
 
?>
<title>Listar Contacto Natural</title>
</head>
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left" style="margin-top:-20px">
                <h2 class="titulolista" align="center" >Contacto Natural</h2>
                <div class="table-responsive contTabla" >
                    <div class="table-responsive contTabla" >
                        <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="campos">
                                        <a class href="#" onclick="javascript:eliminarContNatu(<?php echo $resultado[$i][0]; ?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a>
                                        <a href="modificar_TERCERO_CONTACTO_NATURAL.php?action=1&id_ter_cont_nat=<?php echo base64_encode($resultado[$i][0]); ?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                                    </td>
                                    ...
                                    <td class="campos"><?php echo $resultado[$i][7] ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <div class="form-group form-inline col-sm-6" style="">
                            <div align="right">
                                <a href="modificar_TERCERO_CONTACTO_NATURAL.php?action=2" class="btn btn-primary btnNuevoLista" Style="box-shadow: 0px 2px 5px 1px gray;color: #fff;border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px;">Registrar Nuevo</a>
                            </div> 
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="margin-top: 8px">
                    <p>¿Desea eliminar el registro seleccionado de Contacto Natural?</p>
                </div>
    ...
    <script type="text/javascript">
        function eliminarContNatu(id)  {
            var result = '';
            $("#myModal").modal('show');
            $("#ver").click(function(){
                $("#mymodal").modal('hide');
                jsShowWindowLoad('Eliminando Información...');
                var form_data = {action:3, perfil:10, id:id}
                $.ajax({
                  type:"POST",
