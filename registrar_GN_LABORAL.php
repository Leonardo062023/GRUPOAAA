        ...
        <div class="container-fluid text-center">
              <div class="row content">
                  ...
                  <div class="col-sm-8 text-left" style="margin-top: 0px">
                      ...
                      <h5 id="forma-titulo3a" align="center" style="margin-top:-20px; width:95%; display:<?php echo $a?>; margin-bottom: 10px; margin-right: 4px; margin-left: 4px;  background-color: #0e315a; color: white; border-radius: 5px"><?php echo ucwords((mb_strtolower($datosTercero)));?></h5> 
                       ...
                       if(empty($idT))
                        ...
                        ?>
                          ...
                          <!----------------------------------------------------------------------->
                            ...
                            <input required="required" style="width:18%; height: 32px" class="col-sm-2 col-md-2 col-lg-2 input-sm" type="text" name="txtEntidad" id="txtEntidad" placeholder="Entidad">
                            ...
                            <select name="sltTipo" id="sltTipo" title="Seleccione Tipo Dedicación" style="width: 118px;height: 30px" class="form-control col-sm-1">
...
<!----------------------------------------------------------------------------------------------------->                              
                         <div class="form-group form-inline" style="margin-top:-1px">                
