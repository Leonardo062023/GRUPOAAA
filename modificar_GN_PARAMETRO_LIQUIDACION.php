...
pl.dias_prima_navidad,
pl.tipo_liquidaciond,
pl.aplica_bonificacion
			...
			<div class="col-sm-10 text-left" style="margin-top: -22px">
				...
				<div class="client-form contenedorForma" style="margin-top:-7px">
					<form name="form" id="form" method="POST" action="json/modificarParametroLiquidacionJson.php" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-inline" style="margin-top: 4px;">
                            ...
                            <input type="text" class="form-control col-sm-1" id="txtlimitbon" name="txtlimitbon" style="width: 100px" onkeypress="return txtValida(event,'dec', 'txtlimitbon', '2');" onkeyup="formatC('txtlimitbon');" placeholder="Limite Bonificación Servicios" value="<?=$ro[37];?>">
                             <label for="diaspn" class="control-label col-sm-2" style="margin-left: -20px; font-size: 12px;">Días Prima <br>Navidad:</label>
                            <input type="text" class="form-control col-sm-1" id="diaspv" name="diaspn" style="width: 100px" onkeypress="return txtValida(event,'dec', 'diaspv', '2');"  placeholder="Días Prima Navidad" value="<?=$ro[38];?>">  
                            
                             <label for="sltTipoLi" class="control-label col-sm-2" style="margin-left: -20px; font-size: 12px;"><strong class="obligado">*</strong>Tipo Empleado:</label>
                            <select  class="form-control col-sm-1 select2" id="sltTipoLi" name="sltTipoLi" style="width: 100px;" required="required">
                                
                                <?php
                                if(empty($ro[39])){
                                    echo '<option value="Libre Nombramiento">Libre Nombramiento</option>';    
                                    echo '<option value="Supernumerarios">Supernumerarios</option>';    
                                } else {
                                    echo '<option value="'.$ro[39].'">'.$ro[39].'</option>';  
                                }
                                  if ($ro[39]=="Libre Nombramiento") {
                                       echo '<option value="Supernumerarios">Supernumerarios</option>';   
                                  }elseif ($ro[39]=="Supernumerarios") {
                                      echo '<option value="Libre Nombramiento">Libre Nombramiento</option>';    
                                  }
                                
                               ?>                                
                            </select>
                            <label for="aplica_b" class="control-label col-sm-2" style="margin-left: 80px;font-size: 12px;">Aplica <br> Bonificación:</label> 
                            <?php 
                            if($ro[40]==1){
                                echo '<input type="radio"  id="1" name="aplica_b" value="1"  style="margin-left: 175px;" checked>SI
                                    <input type="radio"  id="2" name="aplica_b" value="2" >NO';
                            } else {
                                echo '<input type="radio"  id="1" name="aplica_b" value="1"  style="margin-left: 175px;">SI
                                <input type="radio"  id="2" name="aplica_b" value="2" checked>NO';
                            }?>  
