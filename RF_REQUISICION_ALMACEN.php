                        ...
                        <div class="form-group form-inline" style="margin-top:-15px">
                            ...
                            <select name="sltDependencia" id="sltDependencia" title="Seleccione dependencia" style="width: 10%" class="col-lg-1 col-sm-1 form-control select2" required>
                                ...
                                if (!empty($dependencia)) {
                                    ...
                                    echo '<option value="' . $fila9[0] . '">' . ucwords(strtolower($fila9[1])) . '</option>';
                                    $sql10 = "SELECT DISTINCT id_unico,nombre FROM gf_dependencia WHERE id_unico != $dependencia AND compania = $compania AND (movimiento =0 OR activa = 0)#AND tipodependencia != 1";
                                    ...
                                    $sql11 = "SELECT DISTINCT id_unico,nombre FROM gf_dependencia WHERE  compania = $compania AND (movimiento =0 OR activa = 0) #AND tipodependencia != 1";
