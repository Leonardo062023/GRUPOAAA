...
<!----------Fin Captura de Mes Inicial-->
             ...
             <div class="form-group" style="margin-top: -5px">
                ...
                <div class="form-group" style="margin-top: -5px" id="niveles">
                    <label for="niveles" class="col-sm-5 control-label"><strong style="color:#03C1FB;"></strong><strong class="obligado"></strong>Niveles:</label>
                    <input type="text" class="form-control" id="niveles" name="niveles" placeholder="Niveles" title="Ingrese Nivel">
                </div> 
...
<script>    
    ...
    $("#tipo").change(function(){
        if($("#tipo").val()!=0){
            $("#niveles").css("display", "none");
        } else {
            $("#niveles").css("display", "block");
        }
    })
</script>
...
<script>
function reportePdf(){
    $('form').attr('action', 'informes/INFORMES_PPTAL/generar_INF_EJEC_PPTAL_RENTAS_INGRESOS.php');
}
</script>
</body>
</html>