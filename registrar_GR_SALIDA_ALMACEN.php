...
$idaso = ""; $tipoAsociado = ""; $id_asoc = ""; $estdo = ""; $sltDocSoporte = ""; $numDocSoporte = "";$fecha_bd = date('Y-m-d'); $cierre = 0;
$compania = $_SESSION['compania'];
$param = $_SESSION['anno'];
if(!empty($_GET['movimiento'])){
    $idMov = $_GET['movimiento'];
    $sql = "SELECT  mv.tipomovimiento, mv.numero, DATE_FORMAT(mv.fecha,'%d/%m/%Y'), mv.centrocosto, mv.proyecto, mv.dependencia, mv.tercero, mv.estado, mv.descripcion, mv.observaciones, mv.id_unico, mv.porcivaglobal, mv.tipo_doc_sop, mv.numero_doc_sop, mv.fecha 
    ...
    $id = $rowPrimaria[10]; $porcIva = $rowPrimaria[11]; $sltDocSoporte = $rowPrimaria[12]; $numDocSoporte = $rowPrimaria[13]; $fecha_bd =$rowPrimaria[14];
...
<body onload="clean_inputs()">
                ...
                <div class="client-form contenedorForma">
                    <form name="form" id="form" class="form-horizontal" method="POST" enctype="multipart/form-data" action="controller/controllerGFSalidaAlmacen.php?action=insert" style="margin-bottom: -28px">
                        ...
                        <div class="form-group" style="margin-top:-15px">
                            ...
                            <select name="sltDependencia" id="sltDependencia" class="col-lg-1 col-sm-1 form-control select2" style="width:10%;" title="Seleccione dependecia " required>
                                ...
                                if (!empty($dependencia)) {
                                    ...
                                    $sql10 = "SELECT DISTINCT id_unico,concat(sigla,' ', nombre) FROM gf_dependencia WHERE id_unico != $dependencia AND tipodependencia != 1 AND compania = $compania AND (movimiento =0 OR activa = 0) ";
                                    ...
                                    $sql11 = "SELECT DISTINCT id_unico,concat(sigla,' ', nombre) FROM gf_dependencia WHERE compania = $compania AND tipodependencia != 1 AND (movimiento =0 OR activa = 0) ";
                        ...
                        <div class="form-group">
                         ...
                         <?php if(!empty($_GET['movimiento'])){?>
                                <div style="margin-top: -15px;margin-bottom: 16px;text-align: right;margin-left: -30px;" class="col-sm-12">
                    ...
                    <form name="form-detalle" id="form-detalle" class="form-horizontal" method="POST" enctype="multipart/form-data" action="access.php?controller=salida&action=guardar_detalle">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1 col-md-1 col-lg-1">
                                <input type="text" name="txtCantI" id="txtCantI" value="" required="" class="form-control" placeholder="Cant." title="Ingrese la cantidad del producto" onkeypress="return txtValida(event, 'dec', 'txtCantI', '5');" style="width: 100px;">
                            ...
                            <div class="col-sm-2 col-md-2 col-lg-2">
                                <input type="text" name="txtValorU" id="txtValorU" value="" required="" class="form-control" placeholder="Valor U." title="Ingrese el valor unitario del producto" onkeypress="return txtValida(event, 'dec', 'txtValorU', '2');" style="width: 150px;">
                            </div>
                            <label class="control-label col-sm-1 col-md-1 col-lg-1 text-left" for=""><strong class="obligado">*</strong>Valor Total:</label>
                            <div class="col-sm-2 col-md-2 col-lg-2">
                                <input type="text" name="txtValorT" id="txtValorT" required="" class="form-control" value="" readonly placeholder="Valor Total" title="Valor total" style="width: 150px;">
                            </div>
                        ...
                        <table id="tablaMovimiento" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="cabeza"><strong>Iva Unitario</strong></th>
                            ...
                            <tbody>
                                ...
                                if(!empty($idMov) && empty($_GET['asociado'])) {
                                    $det = "SELECT    dtm.id_unico, dtm.planmovimiento, dtm.cantidad, dtm.valor, pl.id_unico, pl.nombre, dtm.iva, pl.codi,
                                                      pl.ficha, dtm.detalleasociado, pl.tipoinventario, pl.ficha 
                                    ...
                                    while ($row2 = mysqli_fetch_row($resultado2)) { ?>
                                        <tr><td>
                                            ...
                                            if(empty($af[0][0])){
                                                ...
                                                echo "\n\t\t\t<a href=\"#".$row2[0]."\" class=\"glyphicon glyphicon-edit modificar\" title=\"Modificar\" id=\"mod\" onclick=\"javascript:modificar(".$row2[0]." );return calcular(".$row2[0].")\"></a>";
                                                } 
                                            } ?>
                                ...
                                if(!empty($_GET['asociado'])){
                                    ...
                                    foreach ($dt_ as $ro_) {
                                        ...
                                        if( $xxx > 0){
                                            ...
                                            $html .= "<td class='campos text-right'>".number_format(($ro_[3] + $ro_[6]) * $xxx, 2, ',', '.')."</td>";
    ...
    <script type="text/javascript">
        ...
        $("#sltTipoAsociado").change(function(){
            ...
            console.log($("#sltTipoAsociado").val());
            $.ajax({
                type: 'POST',
                url: "consultasBasicas/consulta_mov.php",
                data:form_data,
    ...
    <script>
        ...
        $("#btnCrearC").click(function(){
            ...
            let id ='<?=$idMov?>'; 
            let form_data = {action: 12,idMov:id };
                ...
                success: function (response)
                {
                   ...
                   let txt = respuesta[0];
                    if(rta>0){
                        ...
                        let form_data = {action: 13,idMov:id };
                        $.ajax({
                            type: "POST",
                            url: "jsonPptal/gf_almacenJson.php",
                            data: form_data,
