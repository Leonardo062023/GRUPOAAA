...
#TERCERO
$tercero ="SELECT distinct  IF(CONCAT_WS(' ', ter.nombreuno, ter.nombredos, ter.apellidouno, ter.apellidodos) IS NULL OR 
          ...
          FROM gf_tercero ter 
          left join gf_perfil_tercero pt ON pt.tercero = ter.id_unico 
          WHERE compania = $compania AND pt.perfil = 2 ORDER BY NOMBRE ASC"; 
