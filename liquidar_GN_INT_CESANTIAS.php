    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left" style="margin-top: 0px">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Liquidación de Intereses de Cesantías</h2>
                    ...
                    <div class="client-form contenedorForma" style="margin-top: -7px;font-size: 13px">
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/liquidarIntCesantiasJson.php">
                            ...
                            <div class="form-group form-inline" style="margin-top:-25px">
                                ...
                                <?php
                                    if(empty($id_P)){
                                        ...
                                        . "FROM gn_periodo p LEFT JOIN gn_tipo_proceso_nomina tpn ON p.tipoprocesonomina = tpn.id_unico "
                                        . "WHERE p.id_unico!=1 AND p.liquidado !=1 AND p.tipoprocesonomina = 10 AND p.parametrizacionanno = '$vig'";
