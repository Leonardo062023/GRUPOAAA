...
switch ($_SESSION['conexion']) {
    case '1':
      $rowTipo = $con->Listar("SELECT id_unico, nombre FROM gg_tipo_dia WHERE md5(id_unico)= '$id'");
    break;
    case '2':
      $rowTipo = $con->Listar("SELECT id_unico, nombre FROM gg_tipo_dia WHERE (id_unico)= '$id'");
  break;
  }
?>
<title>Modificar Tipo Día</title>
</head>
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                ...
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Modificar Tipo Día</h2>
...
<div class="modal fade" id="myModal7" role="dialog" align="center" >
    ...
    <script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "jsonProcesos/modificar_GG_TIPO_DIAJson.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
                                success: function(response)
                                {
                                    ...
                                    if(response==1){
                                      ...
                                      $("#myModal6").modal('hide');
                                      document.location = 'Modificar_GG_TIPO_DIA.php?id=<?php echo ($id);?>';
                                      });
                                }
                                }
                            });
