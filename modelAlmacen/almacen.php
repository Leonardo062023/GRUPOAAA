...
class almacen{
    ...
    public function obtener_tipo($sigla){
        try {      
          $compania = $_SESSION['compania'];
          $sql = "SELECT id_unico, clase FROM gf_tipo_movimiento WHERE sigla = '$sigla' AND compania = $compania";
          $res = $this->mysqli->query($sql);
            return $res->fetch_row();
            $this->mysqli->close();
        } catch (Exception $e) {
    ...
    public function obtener_mov($tipo, $numero){
        try {
            $anno = $_SESSION['anno'];
            $sql = "SELECT id_unico FROM gf_movimiento WHERE tipomovimiento = $tipo AND numero = '$numero' AND parametrizacionanno = $anno";
            $res = $this->mysqli->query($sql);
            return $res->fetch_row();
            $this->mysqli->close();
        } catch (Exception $e) {
