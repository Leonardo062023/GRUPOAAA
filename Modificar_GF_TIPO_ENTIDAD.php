...
if (isset($_GET["id"])){ 
  ...
  switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_tipo_entidad WHERE md5(Id_Unico) = '$id'");
    break;
    case '2':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_tipo_entidad WHERE (Id_Unico) = '$id'");
  break;
  }
}
?>
  <!--titulo de la página-->
<title>Modificar Tipo Entidad</title>
</head>
<body>
...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <div class="col-sm-10 text-left">
      ...
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Modificar Tipo Entidad</h2>
...
<script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarTipo_Entidad.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
