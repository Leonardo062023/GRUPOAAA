...
?>
  <title>Registrar Tipo Tercero</title>
</head>
<body>
<div class="container-fluid text-center">
  ...
  <?php require_once 'menu.php'; ?>
    ...
    <div class="col-sm-10 text-left">
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Registrar Tipo Tercero</h2>
...
<script>
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarTipoTerceroJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
