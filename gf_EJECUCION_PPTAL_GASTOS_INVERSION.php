...
require_once('Conexion/conexion.php'); 
 ...
 $annio = $_SESSION['anno'];
 ?>
<title>Ejecución Presupuestal Gastos - Inversión </title>
...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-10 text-left" style="margin-top: -20px"> 
            <h2 align="center" class="tituloform">Ejecución Presupuestal Gastos e Inversión </h2>
...
function reporteExcel(){
    ...
    $.ajax({
        ...
        success: function(response)
        {
            ...
            var c2 = $("#sltcodf").val();
            var a  = $("#sltAnnio").val();
            //$('form').attr('action', 'informes/INFORMES_PPTAL/INFORME_EJECUCION_GASTOS_EXCEL.php');  
            window.open('informes/INFORMES_PPTAL/INFORME_EJECUCION_GASTOS_EXCEL.php?sltmesi='+m1+'&sltmesf='+m2+'&sltcodi='+c1+'&sltcodf='+c2+'&sltAnnio='+a);
...
<script>
function reportePdf(){
    $('form').attr('action', 'informes/INFORMES_PPTAL/INFORME_EJECUCION_GASTOS.php');  
}
</script>
</body>
</html>