...
if (!empty($_SESSION['id_comp_pptal_ED'])) {
    ...
    $queryCompro = "SELECT
                    ...
                    IF(CONCAT_WS(' ',
                        ...
                        trs.nombredos,
                        trs.apellidouno,
                        trs.apellidodos)) AS NOMBRE,
                    IF(trs.digitoverficacion IS NULL OR trs.digitoverficacion='',
                        trs.numeroidentificacion, 
                    CONCAT(trs.numeroidentificacion, ' - ', trs.digitoverficacion))
                  FROM
                  ...
                  LEFT JOIN 
                    gf_tercero trs ON comp.responsable = trs.id_unico 
                  WHERE
                                    ...
                                    <div class="col-sm-2" align="left" style="padding-left: 0px;">
                                        ...
                                        <?php
                                            ...
                                            if ($af[0] > 0) {
                                                ...
                                                <input class=" input-sm" type="text" name="fecha" id="fecha" class="form-control" style="width:100px;" title="Ingrese la fecha" placeholder="Fecha" value="<?php echo $fecha; ?>"  readonly="readonly" disabled="true">
    <?php } else { ?>
                                                <input class=" input-sm" type="text" name="fecha" id="fecha" class="form-control" style="width:100px;" title="Ingrese la fecha" placeholder="Fecha" value="<?php echo $fecha; ?>"  readonly="true">
    <?php }
} ?>
...
<?php } ?>
                                ...
                                <div class="form-group form-inline col-sm-12" style="margin-top: -35px;"> <!-- Tercera fila -->
                                    <?php if($parametro_res==1) { ?>
                                    
                                    <div class="col-sm-5" style="margin-top: 20px;text-align: left;">
                                       <label for="responsable" class="control-label" style=""><strong style="color:#03C1FB;">*</strong>Responsable:</label><br/>
                                       <select name="responsable" id="responsable" class="select2_single form-control " title="Tercero" style="width:180px; display: inline-block;">
                                            <?php if (!empty($_SESSION['nuevo_ED'])) {
                                                echo '<option value="'.$rowComp[11].'">'. ucwords(mb_strtolower($rowComp[12])).' - '.$rowComp[13].'</option>';
                                                $idd =$rowComp[11];
                                            } else { 
                                                echo '<option value="2">Varios</option>';
                                                $idd =2;
                                            }
                                             $ter = $con->Listar("SELECT DISTINCT t.id_unico, 
                                                IF(CONCAT_WS(' ',
                                                    t.nombreuno,
                                                    t.nombredos,
                                                    t.apellidouno,
                    ...
                    <div class="col-sm-12" > 
                        <div class="client-form form-inline" class="col-sm-10" >
                            <form name="formConRub" id="orm" class="form-inline" method="POST"  enctype="multipart/form-data" onsubmit="return validarValor()" action="json/registrar_EXP_DIS_DETALLE_COMPROBANTEJson.php">
                                ...
                                <?php } elseif($parametro_cc==1) { ?>
                                    <div class="col-sm-3 form-group form-inline" style="padding: 0px;">
                                        <div class="form-group form-inline" style="padding: 0px;">
                                            <label for="concepto" class="control-label" ><strong class="obligado">*</strong>Concepto:</label>
                                        </div>
                                        <br/>
...
<?php } ?>
    ...
    <script type="text/javascript">
        ...
        function modificarCompPptal()
        {
            ...
            var form_data = {estruc: 2, id_com: idComP, tercero:tercero,descripcion: descripcion, fecha: fecha, fechaVen: fechaVen, responsable:responsable};
            $.ajax({
                type: "POST",
                url: "estructura_modificar_eliminar_pptal.php",
                data: form_data,
