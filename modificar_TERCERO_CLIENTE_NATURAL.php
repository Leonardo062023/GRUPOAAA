...
if ($action == 1) {
    ...
    if (isset($_GET["id_ter_clie_nat"])) {
        $id_asoNat = base64_decode(($_REQUEST["id_ter_clie_nat"]));
...
?>
<?php if ($action == 1) { ?>
    <title>Modificar Cliente Natural</title>
<?php }

?>
<?php if ($action == 2) { ?>
    <title>Registrar Cliente Natural</title>
<?php }
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-7 text-left" style="margin-left: -16px;margin-top:-20px">
                <?php if ($action == 1) { ?>
                    <h2 align="center" class="tituloform">Modificar Cliente Natural</h2>
                <?php }

                ?>
                <?php if ($action == 2) { ?>
                    <h2 align="center" class="tituloform">Registrar Cliente Natural</h2>
                <?php }


                ?>

                <a href="TERCERO_CLIENTE_NATURAL.php" class="glyphicon glyphicon-circle-arrow-left" style="display:inline-block;margin-left:10px; font-size:150%; vertical-align:middle;text-decoration:none" title="Volver"></a>
                ...
                <div class="client-form contenedorForma" style="margin-top:-5px">
                    <form name="form" id="form" class="form-horizontal" method="POST" enctype="multipart/form-data" action="">
                        ...
                        <div class="form-group" style="margin-top: -5px;">
                            <label for="nombreC" class="col-sm-5 control-label">Nombre Comercial:</label>
                            <?php if ($action == 1) { ?>
                                <input type="text" value="<?php echo $row[0][11] ?>" name="nombreC" id="nombreC" class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="150" title="Ingrese Nombre Comercial" onkeypress="return txtValida(event,'num_car')" placeholder="Nombre Comercial">
                            <?php }

                            ?>
                            <?php if ($action == 2) { ?>
                                <input type="text" name="nombreC" id="nombreC" class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();"  maxlength="150" title="Ingrese Nombre Comercial" onkeypress="return txtValida(event,'num_car')" placeholder="Nombre Comercial">
                            <?php }
                ...
                <table class="tablaC table-condensed" style="margin-left: -10px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <a href="GF_RESPONSABILIDAD_TERCERO.php?id=<?php echo $_GET["id_ter_clie_nat"]; ?>"><button style="margin-top:15px" class="btn btnInfo btn-primary">RESPONSABILIDADES</button></a><br />
                            </td>
                        </tr>
