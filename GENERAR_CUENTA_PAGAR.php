                        ...
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data"  onsubmit="return validar();"  action="json/registrar_GENERAR_CUENTA_PAGARJson.php">
                            ...
                            <div class="form-group form-inline col-sm-12" style="margin-top: 0px; margin-left: 0px; margin-bottom: 0px;">
                                ...
                                <div class="col-sm-3" align="left">
                                    ...
                                    <select name="tercero" id="tercero" class="select2_single form-control input-sm" title="Seleccione un tipo de comprobante" style="width:180px; " required>
                                        <?php
                                        $seleccionado = '';
                            ...
                            <script>
                                ...
                                <?php if (empty($_SESSION['nuevo_CP'])) { ?>
                                        ...
                                        var form_data = {case: 18, tipo: tipo}
                                        $.ajax({
                                            type: "POST",
                                            ...
                                            if (response == 1)
                                            {
                                                ...
                                                $.ajax({
                                                    ...
                                                    success: function (response)
                                                    {
                                                        ...
                                                        if (response == 0)
                                                        {
                                                            document.location = 'gf_APLICAR_RETENCIONES.php?id=1&mova='+movAlmacen; // Dejar
