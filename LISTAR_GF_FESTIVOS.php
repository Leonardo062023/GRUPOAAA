<?php
#05/04/2017 --- Nestor B --- se agrego el atributo mb para que tome las tildesss
...
switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT id_unico, fecha, descripcion FROM gf_festivos where YEAR(fecha) ='$anno'");
    break;
    case '2':
      $row = $con->Listar("SELECT id_unico,TO_CHAR(fecha,'DD-MM-YYYY') fecha, descripcion FROM gf_festivos where extract(YEAR from fecha) ='2023'");
    break;
}
?>
...
<div class="container-fluid text-center">
 							...
 							for ($i=0; $i <count($row) ; $i++) {?> 
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="Modificar_GF_FESTIVOS.php?id=<?php echo ($row[$i][0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                                    </td>
    ...
    <script type="text/javascript">
                function eliminar(id) {
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificar_GF_FESTIVOSJson.php?action==1",
                                data: form_data,
