...
if($_GET['t']==1){
    ...
    { 
        ...
        { 
            ...
            $this->Ln(4);
            $this->SetX(25);
            $this->Cell(320, 5, utf8_decode('SÁBANA DE PRIMA DE SERVICIOS'), 0, 0, 'C');
            $this->Ln(4); 
            $this->SetFont('Arial', 'B', 8);
            $this->SetX(25);
    ...
    WHERE td.nombre = 'Sabana Prima Servicios'
    ...
    ob_end_clean();
    $pdf->Output(0,'Sabana_Prima_S('.date('d/m/Y').').pdf',0);     
}
#******** Tipo Excel *************#
 else{
    header("Content-type: application/vnd.ms-excel");
    header("Content-Disposition: attachment; filename=Sabana_Prima_S.xls");  
   ...
   if(empty($_REQUEST['sltUnidadE'])){
        ...
        echo '<br/>&nbsp;';
        echo '<br/>SÁBANA DE PRIMA DE SERVICIOS';
        echo '<br/>&nbsp;';
