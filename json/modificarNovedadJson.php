...
//modificar ne la base de datos
  $elm=modificarNovedad($_POST['id'],$_POST['txtValor'],$_POST['sltFecha'],$_POST['sltEmpleado'],$_POST['sltPeriodo'],$_POST['sltConcepto']);

  $insertSQL = "UPDATE gn_novedad SET valor = $valor, fecha = $fecha, empleado = $empleado, periodo = $periodo, concepto = $concepto WHERE id_unico = $id";
