...
$elm = modificarParametrosLiq($_POST['txtIdparametro'],$_POST['sltTipoEmpleado'],$_POST['sltProvision'],
$_POST['txtsalmin'],$_POST['txtauxt'],$_POST['txtprimaA'],$_POST['txtprimaM'],$_POST['txtasempl'],
$_POST['txtasempr'],$_POST['txtapempl'],$_POST['txtapempr'],$_POST['txtafsol'],$_POST['txtextre'],
$_POST['txtacacom'],$_POST['txtasena'],$_POST['txtaicbf'],$_POST['txtaesap'],$_POST['txtamin'],
$_POST['txtvuvt'],$_POST['txttopal'],$_POST['txttopald'],$_POST['slttoauxT'],$_POST['txtinca'],
$_POST['txtrecnoc'],$_POST['txtrecdom'],$_POST['txthextdo'],$_POST['txthextdom'],$_POST['txthextno'],
$_POST['txthextndom'],$_POST['slthextnor'],$_POST['txtredondeo'],$_POST['txtsaludsena'],$_POST['excento'],
$_POST['diaspv']);


echo  $insertSQL = " UPDATE gn_parametros_liquidacion 
 SET 
