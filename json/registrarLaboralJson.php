...
$entidad_laboral        = '"'.$mysqli->real_escape_string(''.$_POST['txtEntidad'].'').'"';
...
$sql = "INSERT INTO gn_laboral(empleado,fechaingreso,fecharetiro,tipodedicacion,dependencia,cargo,causaretiro,entidad_laboral) VALUES
                           ($empleado,$fechaingreso,$fecharetiro,$tipodedicacion,$dependencia,$cargo,$causaretiro,$entidad_laboral)";
