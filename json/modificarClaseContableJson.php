<?php
 ...
 switch ($action) {
   ...
   case 1:
       $id      = $_REQUEST['id'];
       $sql_cons ="DELETE FROM gf_clase_contable WHERE id_unico = :id_unico";
       $sql_dato = array(
               array(":id_unico",$id),
       );
   ...
   case 2:
       ...
       $sql_cons ="INSERT INTO gf_clase_contable (nombre,claseaso) VALUES (:nombre,:claseaso)";
       $sql_dato = array(
               array(":nombre",$nombre),
   ...
   case 3:
       ...
       $claseaso   = $_REQUEST['claseaso'];
       $id       = $_REQUEST['id'];
       $sql_cons ="UPDATE gf_clase_contable SET nombre = :nombre, claseaso = :claseaso WHERE id_unico = :id_unico";
       $sql_dato = array(
            array(":nombre",$nombre),
            array(":claseaso",$claseaso),
            array(":id_unico",$id),
