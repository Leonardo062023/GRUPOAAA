...
$updateSQL = "UPDATE gf_tercero 
        ...
        Contacto =  $contacto, TipoEmpresa = $tipoEmp, TipoEntidad =  $tipoEnt, 
        Zona = $zona, email = $email,equivalente_NE = $codigoE  
    WHERE Id_Unico = $id";
...
if($fila[0]!='9'){
    $insertSQL = "INSERT INTO gf_perfil_tercero (Perfil, Tercero) VALUES(9, $id)";
