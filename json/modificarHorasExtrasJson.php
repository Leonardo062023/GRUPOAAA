...
//modificar ne la base de datos
 $elm =  modificarHorasE($_POST['id'],$_POST['txtnumerohoras'],$_POST['sltFecha'],$_POST['sltEmpleado'],$_POST['sltConcepto']);
  $insertSQL = "UPDATE gn_horas_extras SET numerohoras = $numerohoras, fecha = $fecha, empleado = $empleado, concepto = $concepto WHERE id_unico = $id";
...
<script type="text/javascript">
  ...
  $("#ver1").click(function(){
    $("#myModal1").modal('hide');
    window.location='../listar_GN_HORAS_EXTRAS.php';
  });
</script>
<?php }else{ ?>
<script type="text/javascript">
