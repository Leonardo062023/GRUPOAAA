...
//modificar ne la base de datos
  ...
  $elm = modificarAfiliacion($_POST['id'],$_POST['txtCodigoA'],$_POST['sltFechaA'],$_POST['sltFechaR'],$_POST['txtObservaciones'],$_POST['sltEmpleado'],$_POST['sltTipo'],$_POST['sltTercero'],$_POST['sltEstado']);
