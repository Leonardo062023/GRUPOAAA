...
$insertSQL = "INSERT INTO gf_tercero 
    (RazonSocial, NumeroIdentificacion, DigitoVerficacion, Compania, 
    TipoIdentificacion, Sucursal, RepresentanteLegal, CiudadIdentificacion, 
    TipoRegimen, Contacto, TipoEmpresa, TipoEntidad, Zona, email,equivalente_NE)
    VALUES($razoSoci, $noIdent, $digitVerif, $compania, $tipoIden, 
    $sucursal, $repreLegal, $ciudad, $tipoReg, $contacto, $tipoEmp, 
    $tipoEnt, $zona, $email,$codigoE)";
...
$insertSQL = "INSERT INTO gf_perfil_tercero (Perfil, Tercero) VALUES(9, $row[0])";
$resultado = $mysqli->query($insertSQL);
...
<div class="modal fade" id="myModal1" role="dialog" align="center" >
  ...
  <div class="modal fade" id="myModal2" role="dialog" align="center" >
    ...
    <script type="text/javascript">
      ...
      $("#ver1").click(function(){
        $("#myModal1").modal('hide');
        window.location='../listar_GF_BANCO_JURIDICA.php';
      });
    </script>
    <?php }else{ ?>
    <script type="text/javascript">
