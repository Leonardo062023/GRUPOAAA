...
//Captura de parametrización año o consulta del ID de la tabla parametrización año en caso de ser vacío.
 $parametroAnno = $_SESSION['anno'];
  ...
  VALUES($codigo, '$fecha', '$fechaVen', $parametroAnno, $tipocomprobante, $tercero, $estado, $responsable)";
  }
  else
  {
  ...
  VALUES($codigo, '$fecha', '$fechaVen', $descripcion, $parametroAnno, $tipocomprobante, $tercero, $estado, $responsable)";
  }
  //echo $insertSQL;
