...
if($fecharetiro==""){
  $insertSQL = "UPDATE gn_laboral SET empleado=$empleado, fechaingreso=$fechaingreso, fecharetiro=null,
  tipodedicacion=$tipo, dependencia=$dep, cargo=$car, causaretiro=$causa, entidad_laboral='$ent' WHERE id_unico = $id";
