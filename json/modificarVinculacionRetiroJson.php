...
$elm = modificarVinculacionR($_POST['id'],$_POST['txtNumeroA'],$_POST['sltFechaA'],$_POST['sltFecha'],$_POST['sltEmpleado'],$_POST['sltTipo'],$_POST['sltEstado'],$_POST['sltCausa'],$_POST['sltVinculacion']);
