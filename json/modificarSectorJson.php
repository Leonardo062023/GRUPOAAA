...
switch ($action) {
  case 1:
    ...
    if (count($queryPred) == 0) {
      ...
      $sql_cons = "DELETE FROM gf_sector WHERE Id_Unico = :id_unico";
      $sql_dato = array(
        array(":id_unico", $id)
      );
  ...
  case 2:
    ...
    $sql_cons  = "INSERT INTO gf_sector(Nombre) VALUES (:nombre)";
    $sql_dato = array(
      array(":nombre", $nom),
  ...
  case 3:
    ...
    $sql_cons = "UPDATE gf_sector SET Nombre=:nombre WHERE Id_Unico = :id_unico";
