                    ...
                    <div class="col-sm-2 col-md-2 col-lg-2">
                        <select name="" class="form-control text-left" id="filtrar">
                            ...
                            if(!empty($idReport)){                              # Validamos que la variable $idReport no este vacia
                                ...
                                echo $sql_r = "SELECT tbH.select_table_origen
                                        ...
                                        if($rowTD[0]!=''){
                                            ...
                                            if(!empty($c[0])){                             //Se valida que es diferente de vacio
                                                ...
                                                if(!empty($pos)){                          //Validamos que no venga vacia
                                                    ...
                                                    if($idTablaH[$a]==91){
                                                        $sqlTD1 = $str1." AND codigo_bpin = '$rowTD[0]' $str2"; //Armamos nuestra query para obtener el valor especifico
                                                    } else {
                                                        $sqlTD1 = $str1." AND id_unico = '$rowTD[0]' $str2"; //Armamos nuestra query para obtener el valor especifico
                                                    }
                                                }else{
                                                    if($idTablaH[$a]==91){
                                                        $sqlTD1 = $selectDestino[$a]." AND codigo_bpin = '$rowTD[0]' ";    //Consulta de la tabla destino cuando existe valor en la tabla gn_homologaciones
                                                    } else {
