        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left" style="margin-top: 0px">
                    <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Auxilio Educativo</h2>
                    
                    <div class="client-form contenedorForma" style="margin-top: -6px;font-size: 13px">
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="jsonNomina/gn_LiquidacionAuxilioEducativo.php">                              
                            ...
                            <div class="form-group form-inline" style="margin-top:-25px; height: 100px;">
                                ...
                                <select required="required" name="e" id="e" title="Seleccione Empleado" style="width: 210px;height: 30px" class="form-control col-sm-2">
                          ...
                          <!--------------------------------------------------------------------- -->
                        <?php
                            $per = "SELECT  p.id_unico, CONCAT(p.codigointerno,' - ',tpn.nombre) FROM gn_periodo p LEFT JOIN gn_tipo_proceso_nomina tpn ON p.tipoprocesonomina = tpn.id_unico  WHERE tpn.id_unico =14 AND p.liquidado !=1 AND p.parametrizacionanno = '$vig'";
                        ...
                        <select required="required" name="p" id="p" title="Seleccione Periodo" style="width: 210px;height: 30px" class="form-control col-sm-2">
