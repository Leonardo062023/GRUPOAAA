...
switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT id_unico,nombre FROM gf_pais");
    break;
    case '2':
      $row = $con->Listar("SELECT id_unico,nombre FROM gf_pais");
    break;
  ...
  <div class="row content">
   <?php require_once ('menu.php'); ?>
    ...
    <div class="col-sm-10 text-left" style="margin-top:-22px">
      ...
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Pais</h2>
      ...
      <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;margin-top:-15px">
            ...
            <?php	
               ...
               <tr>
                ...
                <td><!-- Hipervínculos para eliminación y modificación de los registros. -->
                  <a class href="#" onclick="javascript:eliminarPais(<?php echo $row[$i][0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a>
                  <a href="modificar_GF_PAIS.php?id_pais=<?php echo ($row[$i][0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                </td>
          ...
          <div align="right"><a href="registrar_GF_PAIS.php" class="btn btn-primary" style=" box-shadow: 0px 2px 5px 1px gray;color: #fff; 
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="margin-top: 8px">
          <p>¿Desea eliminar el registro seleccionado de Pais?</p>
        </div>
      ...
      function eliminarPais(id)
      {
        $("#myModal").modal('show');
                        $("#ver").click(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificar_GF_Pais_Json.php?action==1",
                                data: form_data,
