...
<script>
   ...
   <title>Liquidación Bonificación por Servicios Prestados</title>
    <link rel="stylesheet" href="css/select2.css">
    <link rel="stylesheet" href="css/select2-bootstrap.min.css"/>
</head>
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-8 text-left" style="margin-top: 0px">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Liquidación Bonificación por Servicios Prestados</h2>
                    ...
                    <div class="client-form contenedorForma" style="margin-top: -7px;font-size: 13px">
                        <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/LiquidarBonSerPJson.php">
                            ...
                            <div class="form-group form-inline" style="margin-top:-25px">
                                <?php 
                                    if(empty($idT))
                                    {
                                        $emp = "SELECT                         
                                                ...
                                                WHERE   e.id_unico = 2 OR vr.estado=1 AND vr.vinculacionretiro IS NULL ORDER BY e.id_unico ";
                                        $idTer = "";
                                    }
                                    else
                                    {
                                ...
                                <?php
                                    if(empty($id_P)){
                                        ...
                                        . "FROM gn_periodo p LEFT JOIN gn_tipo_proceso_nomina tpn ON p.tipoprocesonomina = tpn.id_unico "
                                        . "WHERE p.id_unico!=1 AND p.liquidado !=1 AND p.tipoprocesonomina = 4 AND p.parametrizacioanno = '$vig'";
                                ...
                                <button type="button" id="btnImprimir" class="btn btn-primary shadow" title="Imprimir Volante" disabled><li class="glyphicon glyphicon-print"></li>
                                    </button>
 ...
 <script src="js/md5.js"></script>
    <script type="text/javascript">
        $("#btnImprimir").click(function()
        {
            ...
            window.open('informes/generar_INF_VOLANTE_BON_SERP.php?id_emp='+idemp+'&id_per='+md5(idper));
    ...
    <script type="text/javascript">
        $("#btnSabana").click(function(){
            ...
            var grupo = "";
            var unidad = "";
            window.open('informes/generar_INF_SABANA_BON_SERV.php?id_per='+idper+'&x='+X+'&gr='+grupo+'&un='+unidad);
        });
    </script>
