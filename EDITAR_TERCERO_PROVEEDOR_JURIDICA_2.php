...
if ($action == 1) {
    $id_ter_clie_jur = " ";
    if (isset($_GET["id"])) {
        $id_ter_clie_jur = base64_decode(($_REQUEST["id"]));
    ...
    $_SESSION['url'] = "EDITAR_TERCERO_PROVEEDOR_JURIDICA_2.php?id=" . (($_GET["id"]));
...
<?php if ($action == 1) { ?>
    <title>Modificar Proveedor Jurídica</title>
<?php }

?>
<?php if ($action == 2) { ?>
    <title>Registrar Proveedor Jurídica</title>
<?php }
    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-7 text-left" style="margin-left: -16px;margin-top: -20px; margin-bottom: -15px">
                <?php if ($action == 1) { ?>
                    <h2 class="tituloform" align="center">Modificar Proveedor Jurídica</h2>
                <?php }
                            ...
                            <?php if ($action == 1) { ?>
                                <select name="contacto" id="contacto" class="select2_single form-control" title="Ingrese el contacto">
                                    <?php if (!empty($row[0][13])) {
                                        $auxrowElCon = $row[0][13];
                                        $rowElCon = "SELECT t.Id_Unico, 
                                        CONCAT_WS(' ',t.NombreUno, t.NombreDos, t.ApellidoUno, t.ApellidoDos),
                                        t.NumeroIdentificacion, ti.Nombre 
                                    FROM gf_tercero t, gf_tipo_identificacion ti  
                                    WHERE t.TipoIdentificacion = ti.Id_Unico
                                    AND t.Id_Unico =   $auxrowElCon";
                ...
                <table class="tablaC table-condensed" style="margin-left: -10px">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <h2 class="titulo" align="center" style=" font-size:17px;">Informaci&oacuten adicional</h2>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="GF_TELEFONO.php"><button class="btn btn-primary btnInfo">TEL&EacuteFONO</button></a><br />
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response == 1) {
                        ...
                        document.location = 'LISTAR_TERCERO_PROVEEDOR_JURIDICA_2.php';
