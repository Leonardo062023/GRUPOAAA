...
<script src="js/jquery-ui.js"></script>
   ...
   <title>Aportes y Parafiscales Detallado</title>
    ...
    <body>
        ...
        <div class="col-sm-8 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-top:0px; margin-right: 4px; margin-left: -10px;">Aportes y Parafiscales Detallado</h2>
...
function reportePdf1(){
      ...
      $('form').attr('action', 'informes/generar_INF_APORTES_PARAFISCALES_DET.php');
