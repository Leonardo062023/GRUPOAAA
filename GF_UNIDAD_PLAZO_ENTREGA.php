...
switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_unidad_plazo_entrega");
    break;
    case '2':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_unidad_plazo_entrega");
    break;
          ...
          <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
            ...
            <?php
               ...
               <tr>
                ...
                <td>
                  <a class"" href="#" onclick="javascript:eliminarUnidPlaz(<?php echo $row[$i][0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a>

                  <a href="modificar_GF_UNIDAD_PLAZO_ENTREGA.php?id_unid_plaz=<?php echo ($row[$i][0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                </td>
      ...
      function eliminarUnidPlaz(id)
      {
        $("#myModal").modal('show');
                        $("#ver").click(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificar_GF_UNIDAD_PLAZO_ENTREGAJson.php?action==1",
                                data: form_data,
