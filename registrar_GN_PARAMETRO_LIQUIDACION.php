					...
					<form name="form" id="form" method="POST" action="json/registrarParametroLiquidacionJson.php" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-inline" style="margin-top: 5px;">
                        	...
                        	<input type="text" class="form-control col-sm-1" id="txtlimitbon" name="txtlimitbon" style="width: 100px" onkeypress="return txtValida(event,'dec', 'txtlimitbon', '2');" onkeyup="formatC('txtlimitbon');" placeholder="Limite Bonificación Servicios" >
                             ...
                             <label for="diaspn" class="control-label col-sm-2" style="margin-left: -50px; font-size: 12px;">Días Prima <br>Navidad:</label>
                            <input type="text" class="form-control col-sm-1" id="diaspv" name="diaspn" style="width: 100px" onkeypress="return txtValida(event,'dec', 'diaspv', '2');"  placeholder="Días Prima Navidad">  
                            <br><br><br><br>
                            ...
                            <label for="aplica_b" class="control-label col-sm-2" style="margin-left: -20px; font-size: 12px;"><strong class="obligado">*</strong>Aplica Bonificación:</label>
                            <?php 
