            ...
            <div class="col-sm-10 text-left" style="margin-top:-20px">
                ...
                <div class="table-responsive contTabla" >
                    <div class="table-responsive contTabla" >
                        <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="campos">
                                        <a class href="#" onclick="javascript:eliminarClieNatu(<?php echo $resultado[$i][0]; ?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i>
                                        </a>
                                        <a href="modificar_TERCERO_CLIENTE_NATURAL.php?action=1&id_ter_clie_nat=<?php echo base64_encode($resultado[$i][0]); ?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                                    </td>
                                    ...
                                    <td class="campos"><?php echo ucwords(mb_strtolower($resultado[$i][9])) ?></td>
                        ...
                        <div class="form-group form-inline col-sm-6" style="">
                            <div align="right">
                                <a href="modificar_TERCERO_CLIENTE_NATURAL.php?action=2" class="btn btn-primary btnNuevoLista" Style="box-shadow: 0px 2px 5px 1px gray;color: #fff;border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px;">Registrar Nuevo</a>
                            </div> 
                        </div>
                    </div>
                </div>
