            ...
            <div class="col-sm-10 text-left">
                ...
                <div style="border: 4px solid #020324; border-radius: 10px; margin-left: 4px; margin-right: 4px;" class="client-form">				 	
                    <form name="form" id="form" method="POST" class="form-inline" enctype="multipart/form-data" action="javaScript:guardar()">
                        ...
                        <input type="hidden" name="empleado" value="<?= $ter[0][0] ?>">
                        <div class="form-group form-inline" style="margin-top:-20px; ">                            
                            <label for="centro_costo" class="control-label col-sm-3" style="text-align: right; "><strong style="color:#03C1FB;">*</strong>Centro de Costo:</label>
                            <select name="centro_costo" id="centro_costo" class="select2_single form-control col-sm-3" title="Seleccione Centro de Costo" required="required" style="width:250px;  ">
                        ...
                        <div class="form-group form-inline" style="margin-top:-10px; ">
                            <label for="valor" class="control-label col-sm-3" style="text-align: right; margin-top: 10px"><strong style="color:#03C1FB;"></strong>Valor:</label>
                            <input type="text"  name="valor" id="valor" class="form-control col-sm-3" title="Valor" placeholder="Valor" style="width:150px;  " value="0" />
                        </div>
                        <div class="form-group form-inline" style="margin-top:-10px; ">
                            <label for="porcentaje" class="control-label col-sm-4" style="text-align: right; margin-top: 10px"><strong style="color:#03C1FB;"></strong>Porcentaje:</label>
                            <input type="text"  name="porcentaje" id="porcentaje" class="form-control col-sm-3" title="Porcentaje" placeholder="Porcentaje" style="width:150px; " value="100" max="100"/>
                            ...
                            <tbody>  
                                ...
                                for ($i = 0; $i < count($row); $i++) {
                                    echo '<tr>               
                                        ...
                                        <td class="campos">'.$row[$i][2].'</td>
                                        <td class="campos">'.$row[$i][3].'</td>
                                    </tr>';
                                }
                                ?>
                            </tbody>
...
<?php require_once 'footer.php'; ?>
    ...
    <script>
        ...
        function guardar(){
            ...
            $.ajax({
                type: 'POST',
                url: "jsonNomina/gn_empleado_centro.php?action=1",
                data:formData,
                contentType: false,
                processData: false,
        ...
        function eliminar(id){
            ...
            $("#ver").click(function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "jsonNomina/gn_empleado_centro.php?action=2&id=" + id,
                    success: function (response) {
                        if (response != 0){
