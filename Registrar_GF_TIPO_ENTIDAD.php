...
?>
<!--Titulo de la página-->
<title>Registrar Tipo Entidad</title>
</head>
<body>
...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <!--Titulo del formulario-->
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Registrar Tipo Entidad</h2>
...
<script>
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "json/modificarTipo_Entidad.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
