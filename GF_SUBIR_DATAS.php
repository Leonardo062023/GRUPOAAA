    ...
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-10 text-left">
                <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Subir Archivo Datas</h2>
...
<script>
    function guardar(){
        ...
        $.ajax({
            type: 'POST',
            url: "jsonPptal/gf_datasJson.php?action=1",
            data:formData,
            contentType: false,
            processData: false,
