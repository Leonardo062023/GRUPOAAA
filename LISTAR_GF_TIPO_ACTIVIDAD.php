...
#05/04/2017 --- Nestor B --- se agrego el atributo mb para que tome las tildes
 ...
 switch ($_SESSION['conexion']) {
     case '1':
       $row = $con->Listar("SELECT id_unico,codigo_actividad,nombre FROM gf_tipo_actividad ORDER BY nombre ASC");
     break;
     case '2':
       $row = $con->Listar("SELECT id_unico,codigo_actividad,nombre FROM gf_tipo_actividad ORDER BY nombre ASC");
     break;
 ...
 <body>
 	...
 	<div class="container-fluid text-center">
      ...
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Tipo Actividad</h2>
 					...
 					<div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
 						...
 						<table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
 								...
 								<tr>
 									...
 									<td><strong>Código Actividad</strong></td>
                  ...
                  for ($i=0; $i <count($row) ; $i++) {?>
               							<tr>
                							...
                							<td>
                								...
                								<a href="EDITAR_GF_TIPO_ACTIVIDAD.php?id=<?php echo ($row[$i][0]);?>">
 						...
 						<div align="right">
 							<a href="GF_TIPO_ACTIVIDAD.php" class="btn btn-primary " style=" box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">
 								Registrar Nuevo
 							</a> 
 						</div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="margin-top: 8px">
          <p>¿Desea eliminar el registro seleccionado de Tipo Actividad?</p>
        </div>
  ...
  <script type="text/javascript">
        ...
        $("#myModal").modal('show');
                        $("#ver").click(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarTipoActividadJson.php?action==1",
                                data: form_data,
