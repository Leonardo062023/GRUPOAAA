		...
		<div class="row content">
			...
			<div class="col-sm-10 text-left" style="margin-top: -22px">
				...
				<div class="client-form contenedorForma" style="margin-top:-7px">
					<form name="form" id="form" method="POST" action="" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-inline">
							...
							<label for="sltMesP" class="control-label col-sm-2">
								<strong class="obligado">*</strong>Mes:
							</label>
							<select name="sltMesP" id="sltMesP" title="Seleccione mes" class="form-control input-sm col-sm-1" required style="width: 100px;height: 30px">
								<?php 
								if(empty($mes)){
                        ...
                        <div class="form-group form-inline" style="margin-top: -15px;margin-bottom: 5px">
                        	<div class="col-sm-6 col-sm-offset-6"> 
                                        ...
                                        <div class="col-sm-4"  >
                                            ...
                                            <input type="radio" id="tipoformato1"  name="tipoformato" value="1" checked="checked"> Formato 1<br/>
                                            <input type="radio" id="tipoformato2"  name="tipoformato" value="2"> Formato 2
                                            </div>
	                        	</div>
                                        <!---****Fin Formato******--->
                        		<!-- Botones -->
	                        	...
	                        	<div class="col-sm-1">
	                        		<button  class="btn btn-primary" id="btnGuardar" name="btnGuardar" title="Guardar Conciliación" style="width: 40px;height:34px;cursor: pointer;"><span class="glyphicon glyphicon-floppy-disk"></span></button>                        	
	                        	</div>
	                        	<div class="col-sm-1">
                                            <button class="btn btn-primary" id="btnModificar" title="Modificar Conciliación"  name="btnModificar" style="width: 40px;height:34px;"><span class="glyphicon glyphicon-pencil"></span></button>
	                        	</div>	                            
	                        	<div class="col-sm-1">
                        ...
                        <!--<iframe src="<?php echo substr($ArchivoC,3) ?>" embedded="true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
                                ...
                                <script>
                                    $("#btnGuardar").click(function(){
                                        $('form').attr('action', 'json/registrarGFPartidaConciliatoria.php'); 
                                    })
                                    $("#btnModificar").click(function(){
                                        $('form').attr('action', 'javaScript:actualizarPtd()'); 
                                    })
                                </script>
