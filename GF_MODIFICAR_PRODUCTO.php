...
if (isset($_REQUEST['texto']) && !empty($_REQUEST['texto'])) {
    ...
    switch ($conexion) {
        ...
        case 2:
            echo 'prueba 2';
            $where .= "  AND (pi.codi || ' ' || pi.nombre || ' ' || p.descripcion) LIKE '%$txt%'";
        default:
            # code...
            break;
    }
        ...
        <div class="row content">
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="col-sm-10 col-md-10 col-lg-10 text-right">
                    ...
                    $filas = $con->Listar("SELECT DISTINCT  p.id_unico 
                    ...
                    <div class="contTabla">
                        ...
                        switch ($conexion) {
                            case 1:
                                ...
                                break;
                            case 2:
                                $row  = $con->Listar("SELECT DISTINCT p.id_unico, pi.codi || ' ' || pi.nombre, p.descripcion, p.valor, p.vida_util_remanente, 
                                TO_CHAR(p.fecha_adquisicion, 'DD/MM/YYYY'), pi.ficha 
                                FROM gf_movimiento m 
                                LEFT JOIN gf_detalle_movimiento dm ON m.id_unico = dm.movimiento 
                                LEFT JOIN gf_movimiento_producto mp ON dm.id_unico = mp.detallemovimiento 
                                LEFT JOIN gf_producto p ON mp.producto = p.id_unico 
                                ...
                                $where 
                                ORDER BY p.id_unico 
                                OFFSET $empieza ROWS FETCH NEXT $items ROWS ONLY");
                                break;
                            default:
                                # code...
                                break;
