                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            ...
                            <div class="col-sm-1 col-md-1 col-lg-1 text-left">
                                <a class="btn btn-primary" title="Agregar" href="GF_CONFIGURACION_EXOGENAS.php"><span class="glyphicon glyphicon-plus"></span></a>
                            </div>
                            <div class="col-sm-1 col-md-1 col-lg-1 text-left">
                                <a class="btn btn-primary" title="Generar Informe" href="informes/INF_CONFIGURACION_EXOGENAS.php?formato=<?php echo $_REQUEST['formato'];?>" target="_blank"><span class="fa fa-file-excel-o"></span></a>
                            </div>
                            <div class="col-sm-1 col-md-1 col-lg-1 text-left">
                                <a class="btn btn-primary" title="Generar Informe Nómina-Exogenas" href="informes/INF_CONFIGURACION_EXOGENAS_CONCEPTOS.php?formato=<?php echo $_REQUEST['formato'];?>" target="_blank"><span class="fa fa-file"></span></a>
                            </div>
                        </div>
