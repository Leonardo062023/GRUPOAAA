...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->MultiCell(175, 5, utf8_decode(mb_strtoupper($compa)), 0, 'C');
        $this->SetX(28);
...
$pdf->Ln(5);
$pdf->SetFont('Arial', 'B', 9);
$pdf->CellFitScale(40, 0, utf8_decode('TIPO DE CONTRATACIÓN:'), 0);
$pdf->SetFont('Arial', '', 9);
...
$pdf->SetFont('Arial', 'B', 10);
$pdf->Cell(60, 5, utf8_decode('Se expide en ' . strtoupper($ciudadCompania) . ' a los ' . $diaSb . ' días del mes de ' . $meses[$mesSb] . ' de ' . $anioSb), 0, 0, 'L');
$pdf->Ln(10);
