...
#21/03/2017 |ERICA G. | VALIDAR SI REPRESENTANTE LEGAL ESTA VACIO
#######################################################################################################
...
te.Nombre, 
tipen.Nombre, 
z.Nombre, t.email, d.nombre ,t.equivalente_NE
  FROM gf_tercero t
  ...
  WHERE pt.Perfil = 9 AND t.compania = $compania");

?>
<title>Listar Banco Jurídica</title>
</head>
    <body>
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left" style="margin-top:-20px">
                    <h2 class="titulolista" align="center"> Banco Jurídica</h2>
                    <div class="table-responsive contTabla">
                        <div class="table-responsive contTabla">
                            <table id="tabla" class="table table-striped table-condensed display" cellspacing="0" width="100%">
                                ...
                                <tbody> 
                                    ...
                                    <tr>
                                        ...
                                        <td class="campos">
                                            <a  href="#" onclick="javascript:eliminarBancoJur(<?php echo $resultado[$i][0]; ?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i>
                                          </a>
                                            <a href="modificar_GF_BANCO_JURIDICA.php?action=1&id_bancoJur=<?php echo base64_encode($resultado[$i][0]); ?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i>
                                          </a>
                                        </td>
                                        ...
                                        <td class="campos"><?php echo ucwords(mb_strtolower($resultado[$i][11])) ?></td>
                                        <td class="campos">
                                        <?php if (!empty($resultado[$i][6])) {
                                          $auxid =  $resultado[$i][6];
                                         $rowRL = "SELECT ter.Id_Unico, ter.NombreUno, 
                                                ter.NombreDos, ter.ApellidoUno, ter.ApellidoDos, ter.numeroidentificacion 
                                                FROM gf_tercero ter WHERE ter.Id_Unico = $auxid";
                                           
                                            
                                           echo ucwords(mb_strtolower($resultado[$i][1] . " " . $resultado[$i][2] . " " . $resultado[$i][3] . " " . $resultado[$i][4])).' - '.$resultado[$i][5];
                                        } ?>
                                        </td>
                                        <td class="campos"><?php echo ucwords(mb_strtolower(($resultado[$i][7].' - '.$resultado[$i][14]))) ?></td>
                                        <td class="campos"> 
                                        <?php if (!empty($resultado[$i][9])) {
                                          $auxid = $resultado[$i][9];
                                          $rowRL = "SELECT ter.Id_Unico, ter.NombreUno, 
                                                ter.NombreDos, ter.ApellidoUno, ter.ApellidoDos, ter.numeroidentificacion 
                                                FROM gf_tercero ter WHERE ter.Id_Unico = $auxid";
                                        ...
                                        <td class="campos"><?php echo ($resultado[$i][15]) ?></td>  
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                            ...
                            <div class="form-group form-inline col-sm-6" >
                                <div align="right">
                                    <a href="modificar_GF_BANCO_JURIDICA.php?action=3" class="btn btn-primary btnNuevoLista" Style="box-shadow: 0px 2px 5px 1px gray;color: #fff;border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px;">Registrar Nuevo</a>
                                </div> 
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body" style="margin-top: 8px">
                  <p>¿Desea eliminar el registro seleccionado de Banco Jurídica?</p>
                </div>
        ...
        <script type="text/javascript">
            function eliminarBancoJur(id)
            {
                ...
                $("#ver").click(function(){
                    ...
                    var form_data = {action:3, perfil:9, id:id}
                    $.ajax({
                      type:"POST",
