...
?>
  <title>Registrar Tipo Operacion</title>
</head>
<body>
...
<!-- Llamado al menu del formulario --> 
  <?php require_once 'menu.php'; ?>
    ...
    <div class="col-sm-10 text-left">
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Registrar Tipo Operación</h2>
...
<script>
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarTipoOperJson.php?action=2",
                                data:formData,
                                contentType: false,
                                processData: false,
