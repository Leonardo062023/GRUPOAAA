        ...
        <div class="col-sm-10" style="margin-left: -16px;margin-top: 5px" > 
            ...
            <div class="col-sm-10">
                <div class="client-form contenedorForma col-sm-12"  style=""> <!-- No tenía col-sm-12 -->
                    <form name="form" class="form-horizontal" method="POST" onsubmit="return valida();"  enctype="multipart/form-data" action="jsonPptal/registrar_MOD_REG_COMPROBANTE_PPTALJson.php">
                        ...
                        <div class="form-group form-inline col-sm-12" style="margin-top: 0px; margin-left: -2px; margin-bottom: 0px;"> <!-- Primera Fila -->
                            ...
                            <div class="col-sm-3" align="left" style="padding-left: 0px;"> <!-- Tercero -->
                                ...
                                <select name="tercero" id="tercero" class="select2 form-control input-sm" title="Seleccione un tipo de comprobante" style="width:170px;" <?php if(empty($_SESSION['id_comp_pptal_MR'])){echo 'autofocus=""';}?>  required>
                                     <?php if(empty($registro) && empty($modificacion)) { ?>
                            ...
                            <div class="col-sm-3" align="left" style="padding-left: 0px;"> <!-- Disponibilidad -->
                                ...
                                <select name="solicitudAprobada" id="solicitudAprobada" class="select2  form-control input-sm" title="Número de registro" style="width:170px;">
                                    <?php if (empty($registro) && empty($modificacion)) { ?>
                            ...
                            <script>
                                $("#tercero").change(function(){
                                    ...
                                    var form_data = { estruc: 4, tipo:+$("#tipoComPtal").val(), tercero:+$("#tercero").val() };
                                    $.ajax({
                                      type: "POST",
                                      url: "jsonPptal/consultas.php",
                                      data: form_data,
                            ...
                            <script>
                                $("#solicitudAprobada").change(function(){
                                    ...
                                    document.location = 'MODIFICACION_REGISTRO_PPTAL.php?reg='+md5(registro)+'&tip='+tipo; 
                        ...
                        <div class="form-group form-inline col-sm-12" style="margin-top: -10px; margin-left: -2px; margin-bottom: 0px;"> <!-- Primera Fila -->
                            ...
                            <div class="col-sm-3" align="left" style="padding-left: 0px;"> <!-- Clase de contrato -->
                                ...
                                <select name="claseCont" id="claseCont" class="select2  form-control input-sm" title="Seleccione una clase de contrato" style="width:170px;" required>
                                    <?php if(empty($registro) && empty($modificacion)) { ?>    
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="margin-top: 8px">
                                        ...
                                        <label class="form_label"><strong style="color:#03C1FB;">*</strong>Registro: </label>
                                        <select name="disponibilidad" id="disponibilidad" class="select2  form-control input-sm" title="Número de Registro" style="width:250px;">
                                            <option value="" >Registro</option>
                                        </select> 
                                    </div>
                            ...
                            <div class="modal fade" id="disCorrectoNo" role="dialog" align="center" data-keyboard="false" data-backdrop="static">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="margin-top: 8px">
                                            <p>No se ha podido Agregar Registro</p>
                                        </div>
                                        <div id="forma-modal" class="modal-footer">
                            ...
                            <div class="col-sm-3" style="margin-top: 23px;" > <!-- Buscar disponibilidad -->
                                    ...
                                    <tr>
                                        <td>
                                            <div class="col-sm-3" style="margin-top: -25px; margin-left:-40px" > <!-- Buscar disponibilidad -->
                                                ...
                                                <select class="select2  form-control" name="buscarDisp" id="buscarDisp" style="width:220px">
                                                    <option value="">Registro</option>
                                                    <?php echo $reg = "SELECT
                                                    cp.id_unico,
                                                    cp.numero,
                                                    ...
                                                    WHERE tcp.clasepptal = 15 AND tcp.tipooperacion !=1 AND tcp.vigencia_actual =1 
                                ...
                                <script>
                                    $("#buscarDisp").change(function(){
                                        ...
                                        document.location = 'MODIFICACION_REGISTRO_PPTAL.php?mod='+md5(mod); 
                                    })
                                </script>
                            </div>
                    ...
                    <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                if($tipoO==3){
                                    $valorD = $row3[8];
                                    $afect = "SELECT dc.valor, tc.tipooperacion, dcpa.valor, dc.id_unico  "
                                            . "FROM gf_detalle_comprobante_pptal dc "
                                            . "LEFT JOIN gf_comprobante_pptal cp ON dc.comprobantepptal = cp.id_unico "
                                            . "LEFT JOIN gf_tipo_comprobante_pptal tc ON cp.tipocomprobante = tc.id_unico "
                                    ...
                                    while ($row4 = mysqli_fetch_row($afect)) {
                                        ...
                                        $afecR = "SELECT tc.tipooperacion, dc.valor FROM gf_detalle_comprobante_pptal dc "
                                                . "LEFT JOIN gf_comprobante_pptal cp On dc.comprobantepptal = cp.id_unico "
                                                . "LEFT JOIN gf_tipo_comprobante_pptal tc ON cp.tipocomprobante = tc.id_unico "
                                                . "WHERE tc.tipooperacion !=1 AND dc.comprobanteafectado = $row4[3]";
                                        $afecR = $mysqli->query($afecR);
                                        while ($row2R= mysqli_fetch_row($afecR)) {
                                            if($row2R[0]== 2 || $row2R[0] == 4){
                                                $valorD -=$row2R[1];
