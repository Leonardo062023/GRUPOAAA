...
$id_tipo_base = " ";
if (isset($_GET["id_tipo_base"])){ 
  $id_tipo_base = (($_GET["id_tipo_base"]));
  switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_tipo_base WHERE (Id_Unico) = '$id_tipo_base'");
    break;
    case '2':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_tipo_base WHERE (Id_Unico) = '$id_tipo_base'");
  break;
...
?>
<title>Modificar Tipo Base</title>
<body>
...
<div class="container-fluid text-center">
  ...
  <?php require_once 'menu.php'; ?>
    ...
    <div class="col-sm-10 text-left">
      ...
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Modificar Tipo Base</h2>
...
<script>
                        function modificar(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificar_GF_TIPO_BASEJson.php?action=3",
                                data:formData,
                                contentType: false,
                                processData: false,
