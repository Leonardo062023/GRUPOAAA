...
$_SESSION['url'] = "TerceroEmpleadoNatural2.php";
...
$resZ   = oci_execute($queryZ); 

 ?> 
    <title>Registrar Empleado Natural</title>
...
<body>
    <div class="container-fluid text-center">
        <div class="row content">
            ...
            <div class="col-sm-7 text-left" style="margin-left: -16px;margin-top:-20px">
                <h2 align="center"  class="tituloform">Registrar Empleado Natural</h2>
                ...
                <div class="client-form contenedorForma">
                    <form name="form" id="form" class="form-horizontal" method="POST"  enctype="multipart/form-data" action="json/registrarTerceroEmpleadoNatural2Json.php">
                        ...
                        <div class="form-group" style="margin-top: -10px;">
                            ...
                            <input type="text" name="tarjetaP" id="tarjetaP" class="form-control" maxlength="500" title="Ingrese Tarjeta Profesional" placeholder="Tarjeta Profesional" >
                        </div>
                        <div class="form-group" style="margin-top: -10px;">
            ...
            <div class="col-sm-7 col-sm-3" style="margin-top:-22px"> 
                <table class="tablaC table-condensed"  style="margin-left: -30px">
					...
					MOVIMIENTO CONTABLE
                            ...
                            <td>
                                <a class="btn btn-primary btnInfo" disabled="true">DIRECCIÓN</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
					...
					MOVIMIENTO PRESUPUESTAL
                            ...
                            <td>
                            <a href="GF_CUENTA_BANCARIA_TERCERO.php" >
                                <button class="btn btn-primary btnInfo" disabled="true" <?php if (!isset($_SESSION['id_tercero'])){ echo ' disabled title="Debe primero ingresar un empleado natural."';}?>> 
                                    CUENTA BANCARIA
                                </button> 
                            </a><br/>
                            </td>
					...
					MOVIMIENTO<br/>ALMACEN
                            ...
                            <td>
                              <a href="GF_TIPO_ACTIVIDAD_TERCERO.php" >
                                <button class="btn btn-primary btnInfo" disabled="true" <?php if (!isset($_SESSION['id_tercero'])){ echo ' disabled title="Debe primero ingresar un empleado natural."';}?>> 
                                    TIPO ACTIVIDAD
                                </button> 
                            </a><br/>
        ...
        function existente(){
            ...
            if(tipoD == null || tipoD == '' || tipoD == "Tipo Identificación" || numI == null || numI == ""){
              $("#myModal2").modal('show');
                ...
                $.ajax({
                data: {"numI": numI,perfil:2, action:2},
                type: "POST",
    ...
    <script type="text/javascript">
  	$('#ver1').click(function(){
            ...
            document.location = 'EDITAR_TERCERO_EMPLEADO_NATURAL2.php?id='+id;
        });
    </script>	
</body>
</html>