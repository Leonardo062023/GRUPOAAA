...
$anno = $_SESSION['anno'];
 $sql = "SELECT         pl.id_unico,  pl.vigencia, pl.salmin, pl.auxt,
                        ...
                        pl.limite_bon_servicios,pl.dias_prima_navidad,
                        pl.tipo_liquidaciond,pl.aplica_bonificacion                  
                            ...
                            <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <td class="cabeza"><strong>Días Prima<br>Navidad</strong></td>
                                        <td class="cabeza"><strong>Tipo Liquidación</td>
                                        <td class="cabeza"><strong>Aplica Bonificación</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th class="cabeza">Días Prima<br>Navidad</th>
                                        <th class="cabeza">Tipo Liquidación</th>
                                        <th class="cabeza">Aplica Bonificación</th>
                                    </tr>
                                </thead>    
                                <tbody>
                                    <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td class="campos"><?php echo $diaspn ?></td>
                                        <td class="campos"><?php echo $tipoL ?></td>
                                        <td class="campos"><?php if ($aplica_b == '1'){echo "Si";}else{echo "No";}?></td>
                                    </tr>
                                    <?php }
                                    ?>
                                </tbody>
