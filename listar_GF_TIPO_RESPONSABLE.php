...
switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_tipo_responsable");
    break;
    case '2':
      $row = $con->Listar("SELECT Id_Unico, Nombre FROM gf_tipo_responsable");
    break;
...
?>
    <title>Listar Tipo Responsable</title>
  </head>
<body>
...
<!-- Lllamado al menu -->
  <?php require_once 'menu.php'; ?>
    <div class="col-sm-10 text-left">
      ...
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Tipo Responsable</h2>
...
<!-- Fin de cabeza de tabla-->
            ...
            <tbody>
              ...
              for ($i=0; $i <count($row) ; $i++) {?>
               <tr>
                ...
                <td>
                  <a class"" href="#" onclick="javascript:eliminarTipoR(<?php echo $row[$i][0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a>
                  <a href="modificar_GF_TIPO_RESPONSABLE.php?id_tipoR=<?php echo ($row[$i][0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a>
                </td>
 ...
 <!-- Inicio de bóton de nuevo registro -->
          <div align="right"><a href="registrar_GF_TIPO_RESPONSABLE.php" class="btn btn-primary sombra" style=" box-shadow: 0px 2px 5px 1px gray;color: #fff; border-color: #1075C1; margin-top: 20px; margin-bottom: 20px; margin-left:-20px; margin-right:4px">Registrar Nuevo</a> </div>       
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" style="margin-top: 8px">
          <p>¿Desea eliminar el registro seleccionado de Tipo Responsable?</p>
        </div>
...
<script type="text/javascript">
      ...
      function eliminarTipoR(id)
      {
        $("#myModal").modal('show');
                        $("#ver").click(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarTiporesponsableJson.php?action==1",
                                data: form_data,
  ...
  <script type="text/javascript">
      ...
      $('#ver1').click(function(){
        document.location = 'listar_GF_TIPO_RESPONSABLE.php';
      });
