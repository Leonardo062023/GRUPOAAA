<?php
#05/04/2017 --- Nestor B --- se agregó el atributo mb para que tome las tildes y se elimino la linea de código session_star()
...
switch ($_SESSION['conexion']) {
    case '1':
      $row = $con->Listar("SELECT Cl.Id_Unico, Cl.Nombre, C.Nombre
      FROM gf_clase Cl LEFT JOIN gf_clase C
      ON Cl.ClaseAso = C.Id_Unico");
  ...
  <div class="row content">
    ...
    <div class="col-sm-10 text-left">
      ...
      <div class="table-responsive" style="margin-left: 5px; margin-right: 5px;">
          ...
          <table id="tabla" class="table table-striped table-condensed" class="display" cellspacing="0" width="100%">
            ...
            <?php
               ...
               <tr>
                ...
                <td><a href="#" onclick="javascript:eliminarClase(<?php echo $row[$i][0];?>);"><i title="Eliminar" class="glyphicon glyphicon-trash"></i></a><a href="modificar_GF_CLASE.php?id_clase=<?php echo($row[$i][0]);?>"><i title="Modificar" class="glyphicon glyphicon-edit" ></i></a></td>
          ...
          <div align="right"><a href="registrar_GF_CLASE.php" class="btn btn-primary " style=" box-shadow: 0px 2px 5px 1px gray;
      ...
      function eliminarClase(id)
      {
        $("#myModal").modal('show');
                        $("#ver").click(function(){
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "Json/modificarClaseJson.php?action==1",
                                data: form_data,
