    ...
    <div class="modal-dialog container">
        <div class="modal-content" style="width:800px">
                ...
                <div class="modal-body" style="margin-top: 8px">
                    <div class="row">
                        <form name="form" id="formProducto" class="form-horizontal col-sm-10 col-lg-10" method="POST"  enctype="multipart/form-data" action="" >
                            <div style="margin-top:-20px;" class="client-form">
                                ...
                                <div class="form-group form-inline" style="margin-top:5px;">
                                    ...
                                    $vFicha ="";
                                    $valorE = "";
                                    $requeridos ="txtValor,txtDescripcionProducto ";
                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <button type="submit" style="margin-left:-13px;" title="Generar" onclick="return generarJson('formProducto')" class="btn btn-primary" name="btnAplicar">Guardar</button>
                                    </div>
                                    <script type="text/javascript">
