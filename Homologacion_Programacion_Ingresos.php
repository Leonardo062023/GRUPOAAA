...
<title>Programación_Ingresos</title>
</head>
<body>
...
<div class="container-fluid text-center">
  <div class="row content">
    ...
    <!--Titulo del formulario-->
      <h2 id="forma-titulo3" align="center" style="margin-bottom: 20px; margin-right: 4px; margin-left: 4px;">Homologación Programación de Ingresos</h2>
 ...
 <script type="text/javascript" src="js/menu.js"></script>
  ...
  function subir(){
       ...
       var formData = new FormData($("#form")[0]);  
        ...
        $.ajax({
            type: 'POST',
            url: "HOMOLOGACIONES/Programacion_Ingresos.php",
            data:formData,
            contentType: false,
             processData: false,
